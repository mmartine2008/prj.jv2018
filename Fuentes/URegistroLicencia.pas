...
uses
  ...
  IdMessageClient, IdSMTP,IniFiles, JvExControls, JvLabel, JvGIF,
...
begin
  inherited;
  LPegarLicencia.Caption := Traducir('Copiar el número de licencia y pegarlo en el casillero de licencia para finalizar el proceso de registro');
  case TipoRegistro of
    1,2 : LPegarLicencia.Caption := Traducir('Copiar el número de licencia que se le envio en el mail y pegarlo en el casillero de licencia para finalizar el proceso de registro');
    3 : LPegarLicencia.Caption := Traducir('Copiar el número de licencia que aparece en la página y pegarlo en el casillero de licencia para finalizar el proceso de registro');
  end;
end;
