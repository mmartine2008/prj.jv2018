inherited FDOSRATipiSangADN: TFDOSRATipiSangADN
  Left = 354
  Top = 58
  Caption = 'FDOSRATipiSangADN'
  ClientHeight = 658
  ClientWidth = 845
  OldCreateOrder = True
  OnClose = FormClose
      ...
      inline Mangazo1: TMangazo
        ...
        inherited GBFiltro: TGroupBox
          ...
          inherited IBuscarAnimal: TImage
            OnClick = Mangazo1IBuscarAnimalClick
          end
        ...
        inherited IBQDisponibles: TIBQuery
          SQL.Strings = (
              ...
              'select ta.id_animal, ta.id_rp, ta.id_senasa, cr.sinonimo as raza' +
              ', ta.nombre from tab_animales ta join cod_razas cr on ta.raza = ' +
              'cr.id_raza where ta.establecimiento = :establecimiento and id_an' +
              'imal not in (select id_animal from aux_animales)'
            '')
          ParamData = <
            item
              DataType = ftUnknown
        ...
        inherited IBQSeleccionados: TIBQuery
          AfterDelete = Mangazo1IBQSeleccionadosAfterDelete
          AfterPost = Mangazo1IBQSeleccionadosAfterPost
          SQL.Strings = (
            
              'select id_animal, id_rp, id_senasa, v1 as raza,nombre, id_aux fr' +
              'om aux_animales'
            '')
          Top = 342
        end
    ...
    object TSCertificado: TTabSheet
      ...
      object ScrollBox1: TScrollBox
        ...
        object Label14: TLabel
          ...
          Width = 178
          Height = 13
          Caption = 'SOCIDAD RURAL ARGENTINA'
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clWindowText
          Font.Height = -12
        ...
        object BDBGTipiADN: TBitDBGrid
          Left = 22
          Top = 235
          Width = 793
          Height = 121
          DataSource = DSTipiADN
          FixedColor = clWhite
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clWindowText
          Font.Height = -12
          ...
          Columns = <
            ...
            item
              ...
              ReadOnly = True
              Title.Caption = 'Tipificaci'#243'n Sanguinea'
              Width = 70
              Visible = True
            end
            item
            ...
            item
              ...
              ReadOnly = True
              Title.Caption = 'Tipificaci'#243'n Sanguinea Madre'
              Width = 150
              Visible = True
            end
            item
            ...
            item
              ...
              ReadOnly = True
              Title.Caption = 'Tipificaci'#243'n Sanguinea Padre'
              Width = 150
              Visible = True
            end
            item
        ...
        object ETEEstablecimiento: TEdit
          Left = 195
          Top = 183
          Width = 86
          Height = 23
        ...
        object ETEAdministrativo: TEdit
          Left = 414
          Top = 183
          Width = 94
          Height = 23
        ...
        object ENroCuentaCorriente: TEdit
          Left = 711
          Top = 155
          Width = 96
          Height = 23
  ...
  inherited PTitulo: TPanel
    Width = 845
    Caption = 'Tipificaci'#243'n Sanguinea y ADN - SRA'
  ...
  object IBDSTipiADN: TIBDataSet
    ...
    InsertSQL.Strings = (
      'insert into aux_eventos'
        ...
        '  (ID_ANIMAL, V1, ID_HBA, V2, ID_RP, VUNO1, FECHA, NOMBRE, OBSER' +
        'VACION, '
      
        '   ID_OTRO, V3, ID_PC, V4, OBSERVACION2, OBSERVACION3, ID_RA, V5' +
        ', ID_IE, '
      '   V6, OBSERVACION4, OBSERVACION5, VUNO2, VUNO3)'
      'values'
      
        '  (:ID_ANIMAL, :V1, :ID_HBA, :V2, :ID_RP, :VUNO1, :FECHA, :NOMBR' +
        'E, :OBSERVACION, '
      
        '   :ID_OTRO, :V3, :ID_PC, :V4, :OBSERVACION2, :OBSERVACION3, :ID' +
        '_RA, :V5, '
      '   :ID_IE, :V6, :OBSERVACION4, :OBSERVACION5, :VUNO2, :VUNO3)')
    RefreshSQL.Strings = (
      'Select *'
      'from aux_eventos '
      'where'
    ...
    SelectSQL.Strings = (
        ...
        'select id_animal,v1,id_hba,v2,id_rp,vuno1,fecha,nombre,observaci' +
        'on, id_otro,v3,id_pc,v4,observacion2,observacion3,id_ra,v5,id_ie' +
        ',v6,observacion4,observacion5,vuno2,vuno3 from aux_eventos')
    ModifySQL.Strings = (
      'update aux_eventos'
      'set'
      '  ID_ANIMAL = :ID_ANIMAL,'
  ...
  object IBQREPTipiADN: TIBQuery
    Database = FPrincipal.IBDPrincipal
    Transaction = FPrincipal.IBTPrincipal
    BufferChunks = 1000
    CachedUpdates = False
    SQL.Strings = (
      'select * from rep_tipificacion_adn(:establecimiento)')
    Left = 612
    Top = 424
    ParamData = <
      item
  ...
  object DSTipiADN: TDataSource
    DataSet = IBDSTipiADN
    Left = 572
    Top = 456
  end
  object DSREPTipiADN: TDataSource
    DataSet = IBQREPTipiADN
    Left = 620
    Top = 456
  end
  object IBQDelAuxEventos: TIBQuery
    Database = FPrincipal.IBDPrincipal
    Transaction = FPrincipal.IBTPrincipal
    BufferChunks = 1000
    CachedUpdates = False
