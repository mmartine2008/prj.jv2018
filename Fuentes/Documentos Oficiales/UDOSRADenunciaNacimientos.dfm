inherited FDOSRADenunciaNacimientos: TFDOSRADenunciaNacimientos
  Left = 0
  Top = 34
  Caption = 'FDOSRADenunciaNacimientos'
  ClientHeight = 691
  ClientWidth = 1007
  OldCreateOrder = True
  PixelsPerInch = 96
  ...
  object GBFechas: TGroupBox [5]
    ...
    object DTPInicio: TDateTimePicker
      ...
      Width = 200
      Height = 21
      Date = 38702.597731296290000000
      Time = 38702.597731296290000000
      TabOrder = 0
      OnCloseUp = DTPcloseUpFechas
    ...
    object CBxTipoRegistro: TComboBox
      ...
      ItemHeight = 14
      TabOrder = 3
      OnChange = CBxTipoRegistroChange
      OnCloseUp = CBxTipoRegistroCloseUp
    end
  end
  object GroupBox1: TGroupBox [6]
    ...
    ParentFont = False
    TabOrder = 2
    object BDBGNacimientos: TBitDBGrid
      Left = 2
      Top = 18
      Width = 1003
      Height = 335
      Align = alClient
      DataSource = DSDenunciaNacimiento
      ...
      OnDblClick = BDBGNacimientosDblClick
      OnMouseMove = BDBGNacimientosMouseMove
  ...
  inherited DTXLS: TDataToXLS
    ...
    Title.Text = 'Denuncia de Nacimientos - SRA'
    Left = 184
    Top = 9
  end
  ...
  object DSDenunciaNacimiento: TDataSource
    DataSet = IBQDenunciaNacimiento
    Left = 80
    Top = 14
  end
  object IBQDenunciaNacimiento: TIBQuery
    Database = FPrincipal.IBDPrincipal
    Transaction = FPrincipal.IBTPrincipal
    AfterOpen = IBQDenunciaNacimientoAfterOpen
    BufferChunks = 1000
    CachedUpdates = False
    SQL.Strings = (
      
        'select * from REP_DENUNCIA_NACIMIENTOS_SRA(:esta, :inicio, :fin,' +
        ' :grupo, :potrero, :vacio, :tiporeg, :raza_a)')
    Filtered = True
    Left = 112
    Top = 16
    ParamData = <
  ...
  object IBQGetTiposRegistro: TIBQuery
    Database = FPrincipal.IBDPrincipal
    Transaction = FPrincipal.IBTPrincipal
    BufferChunks = 1000
    CachedUpdates = False
