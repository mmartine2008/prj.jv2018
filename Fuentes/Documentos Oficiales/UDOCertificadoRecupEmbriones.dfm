inherited FDOCertificadoRecupEmbriones: TFDOCertificadoRecupEmbriones
  Left = 78
  Top = 56
  Caption = 'FDOCertificadoRecupEmbriones'
  ClientHeight = 733
  ClientWidth = 845
  OldCreateOrder = True
  PixelsPerInch = 96
  ...
  object PCDatos: TPageControl [4]
    ...
    object TSDatos: TTabSheet
      ...
      object GroupBox1: TGroupBox
        ...
        object DBLCBADonante: TDBLookupComboBoxAuto
          Left = 139
          Top = 82
          Width = 259
          Height = 22
          Color = 14679807
          KeyField = 'ID_ANIMAL'
          ListField = 'NOMBRE_COM'
          ListSource = DSDonante
          TabOrder = 0
          OnCloseUp = DBLCBADonanteCloseUp
          EsClave = False
          EsRequerido = True
          ISParam = False
        end
      ...
      object GroupBox2: TGroupBox
        ...
        TabOrder = 1
        object BDBGColecta: TBitDBGrid
          Left = 2
          Top = 16
          Width = 833
          Height = 154
          Align = alClient
          DataSource = DSDatosColecta
          ...
          TitleFont.Style = []
          OnCellClick = BDBGColectaCellClick
          ...
          Columns = <
            ...
            item
              Alignment = taCenter
              Expanded = False
              FieldName = 'CANT_EMBRIONES_TE'
              Title.Alignment = taCenter
              Title.Caption = 'Cant. Embriones Transferibles'
              Width = 75
              Visible = True
            end
            item
              Alignment = taCenter
              Expanded = False
              FieldName = 'CANT_EMBRIONES_NF'
              Title.Alignment = taCenter
              Title.Caption = 'Cant. Embriones Sin Fertilizar'
              Width = 67
              Visible = True
            end
            item
              Alignment = taCenter
              Expanded = False
              FieldName = 'CANT_EMBRIONES_DEG'
              Title.Alignment = taCenter
              Title.Caption = 'Cant. Embriones Degenerados'
              Width = 79
              Visible = True
            end
            item
              Alignment = taCenter
              Expanded = False
              FieldName = 'CANT_EMBRIONES_TR'
              Title.Alignment = taCenter
              Title.Caption = 'Cant Embriones Transferidos'
              Width = 66
              Visible = True
            end
            item
              ...
              Title.Alignment = taCenter
              Title.Caption = 'Fecha de Servicio'
              Width = 69
              Visible = True
            end
            item
            ...
            item
              Alignment = taCenter
              Expanded = False
              FieldName = 'CONGELADOS'
              Title.Caption = 'Cant. Congelados'
              Width = 95
              Visible = True
            end
            item
        ...
        inline FSeleccion: TFrameSeleccion
          ...
          inherited IBQDisponibles: TIBQuery
            SQL.Strings = (
                ...
                'select ta.id_animal, ta.id_rp, ta.id_senasa, ta.raza, te.dias_ge' +
                'stacion, te.estadio, te.calidad, ee.fecha from tab_animales ta j' +
                'oin eve_eventos ee on ta.id_animal = ee.animal and ta.establecim' +
                'iento = ee.establecimiento join eve_transferencia et on ee.id_ev' +
                'ento = et.id_evento join tab_embriones te on et.embrion = te.id_' +
                'embrion where te.fecha_coleccion = :fecha and te.madre = :madre ' +
                'and te.padre_1 = :p1 and te.padre_2 = :p2 and id_animal not in (' +
                'select id_animal from aux_animales)')
            ParamData = <
              item
                DataType = ftUnknown
                Name = 'fecha'
          ...
          inherited IBUSQLIntercambiar: TIBUpdateSQL
            ...
            InsertSQL.Strings = (
              'insert into aux_animales'
                ...
                '  (ID_AUX, ID_ANIMAL, ID_RP, ID_SENASA, RAZA, NOMBRE, POTRERO, L' +
                'OTE, RODEO, '
              '   FECHA_NACIMIENTO)'
              'values'
              
                '  (:ID_AUX, :ID_ANIMAL, :ID_RP, :ID_SENASA, :RAZA, :NOMBRE, :POT' +
                'RERO, :LOTE, '
              '   :RODEO, :FECHA_NACIMIENTO)')
            DeleteSQL.Strings = (
          ...
          inherited IBQSeleccionados: TIBQuery
            SQL.Strings = (
                ...
                'select id_aux, id_animal, id_rp, id_senasa, raza,nombre, potrero' +
                ', lote, rodeo , fecha_nacimiento from aux_animales')
          end
        end
      end
    end
    object TSCertificado: TTabSheet
      ...
      object ScrollBox1: TScrollBox
        ...
        object Label42: TLabel
          ...
          Width = 150
          Height = 13
          Caption = 'Recuperaci'#243'n Embrionaria'
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clWindowText
          Font.Height = -12
          Font.Name = 'MS Sans Serif'
        ...
        object Label12: TLabel
          ...
          Width = 367
          Height = 13
          Caption = 'A              CERTIFICADO DE RECUPERACI'#211'N DE EMBRIONES'
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clWindowText
          Font.Height = -12
          Font.Name = 'MS Sans Serif'
        ...
        object Label18: TLabel
          ...
          Width = 114
          Height = 14
          Caption = 'N'#186' INSCRIPCI'#211'N S.R.A.:'
        end
        ...
        object LHBADonante: TLabel
          Left = 356
          Top = 305
          Width = 3
          Height = 14
        end
        object LRPDonante: TLabel
          Left = 598
          Top = 305
          Width = 3
          Height = 14
        ...
        object LNombrePadre1: TLabel
          Left = 210
          Top = 333
          Width = 3
          Height = 14
        end
        object LTSPadre1: TLabel
          Left = 124
          Top = 356
          Width = 3
          Height = 14
        ...
        object LNombrePadre2: TLabel
          Left = 210
          Top = 389
          Width = 3
          Height = 14
        end
        object LHBAPadre2: TLabel
          Left = 356
          Top = 412
          Width = 3
          Height = 14
        ...
        object Label41: TLabel
          ...
          Width = 182
          Height = 14
          Caption = 'Nombre/Razon Social Titular del Libro:'
        end
        ...
        object Label45: TLabel
          ...
          Width = 121
          Height = 14
          Caption = 'Embriones Degenerados:'
        end
        object LEmbrionesDeg: TLabel
          Left = 156
          Top = 559
          Width = 3
          Height = 14
        end
        object LEmbrionesSinF: TLabel
          Left = 346
          Top = 559
          Width = 3
          Height = 14
        ...
        object Label47: TLabel
          ...
          Width = 115
          Height = 14
          Caption = 'Embriones Sin Fertilizar:'
        end
        object Label46: TLabel
          ...
          Width = 120
          Height = 14
          Caption = 'Embriones Transferibles:'
        end
        object LEmbrionesTransferibles: TLabel
          Left = 552
          Top = 559
          Width = 3
          Height = 14
        end
        object LEmbrionesTransferidos: TLabel
          Left = 744
          Top = 559
          Width = 3
          Height = 14
        ...
        object Label49: TLabel
          ...
          Width = 118
          Height = 14
          Caption = 'Embriones Transferidos:'
        end
        object Label48: TLabel
          ...
          Width = 373
          Height = 13
          Caption = 'B              CERTIFICADO DE TRANSFERENCIA DE EMBRIONES'
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clWindowText
          Font.Height = -12
          Font.Name = 'MS Sans Serif'
        ...
        object Label51: TLabel
          ...
          Width = 165
          Height = 13
          Caption = 'Identificaci'#243'n de Receptoras'
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clWindowText
          Font.Height = -12
          Font.Name = 'MS Sans Serif'
        ...
        object Label70: TLabel
          ...
          Width = 68
          Height = 14
          Caption = 'Total Frescos:'
        end
        object LtotalCong: TLabel
          Left = 352
          Top = 583
          Width = 3
          Height = 14
        end
        object LtotalEmbriones: TLabel
          Left = 157
          Top = 582
          Width = 3
          Height = 14
        end
        object LtotalFrescos: TLabel
          Left = 555
          Top = 583
          Width = 3
          Height = 14
        end
        object PanelCongelados: TPanel
          Left = 8
          Top = 812
          Width = 785
          Height = 553
          ...
          object Label52: TLabel
            ...
            Width = 358
            Height = 13
            Caption = 'C              CERTIFICADO DE CONGELACI'#211'N DE EMBRIONES'
            Font.Charset = DEFAULT_CHARSET
            Font.Color = clWindowText
            Font.Height = -12
            Font.Name = 'MS Sans Serif'
          ...
          object Label53: TLabel
            ...
            Height = 14
            Caption = 
              'Certifico haber dado cumplimiento a las disposiciones sanitarias' +
              ' vigentes establecidas por SENASA'
          end
          ...
          object Label55: TLabel
            ...
            Width = 250
            Height = 14
            Caption = 'Tiempo desde la recuperaci'#243'n hasta la congelaci'#243'n:'
          end
          ...
          object Label57: TLabel
            ...
            Width = 117
            Height = 14
            Caption = 'Periodo de equilibraci'#243'n:'
          end
          ...
          object Label60: TLabel
            ...
            Width = 108
            Height = 14
            Caption = 'Transferencia Directa:'
          end
          object MObservacionCong: TMemo
            Left = 1
            Top = 36
            Width = 776
            Height = 61
          ...
          object BDBGEmbriones: TBitDBGrid
            ...
            Columns = <
              ...
              item
                ...
                FieldName = 'DESTINO'
                Title.Alignment = taCenter
                Title.Caption = 'Embri'#243'n Dividido'
                Width = 115
                Visible = True
              end>
          end
          object EATiempoRecuperacion: TEdit
            Left = 284
            Top = 332
            Width = 424
            Height = 20
          ...
          object DBLCBADescDestinos: TDBLookupComboBoxAuto
            Left = 87
            Top = 358
            Width = 173
            Height = 22
            ...
            ListField = 'NOMBRE'
            ListSource = DSDescDestinos
            TabOrder = 4
            EsClave = False
            EsRequerido = False
            ISParam = False
          end
          object EAEquilibracion: TEdit
            Left = 145
            Top = 387
            Width = 561
            Height = 20
          ...
          object EATransferenciaDirecta: TEdit
            Left = 126
            Top = 466
            Width = 582
            Height = 20
        ...
        object BDBGReceptoras: TBitDBGrid
          Left = 9
          Top = 682
          Width = 776
          Height = 121
          DataSource = DSReceptoras
          FixedColor = clWhite
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clWindowText
          Font.Height = -12
          ...
          Columns = <
            ...
            item
              ...
              ReadOnly = True
              Title.Alignment = taCenter
              Title.Caption = 'D'#237'as desde Celo'
              Width = 87
              Visible = True
            end
            item
        ...
        object EACriadorServicio: TEdit
          Left = 234
          Top = 462
          Width = 126
          Height = 22
        ...
        object EATitularServicio: TEdit
          Left = 220
          Top = 487
          Width = 581
          Height = 20
  ...
  inherited PTitulo: TPanel
    Width = 845
    Caption = 'Certificado de Recuperaci'#243'n de Embriones'
  ...
  object IBQDonantes: TIBQuery
    Database = FPrincipal.IBDPrincipal
    Transaction = FPrincipal.IBTPrincipal
    AfterOpen = IBQDonantesAfterOpen
    OnCalcFields = IBQDonantesCalcFields
    BufferChunks = 1000
    CachedUpdates = False
    SQL.Strings = (
      
        'select distinct(ta.id_animal), ta.id_rp, ta.nombre, ta.id_hba, t' +
        'a.raza, ta.tipificacion_sanguinea, ta.criador from tab_animales ' +
        'ta join eve_eventos ee on ee.animal = ta.id_animal and ee.establ' +
        'ecimiento = ta.establecimiento join eve_flushing ef on ee.id_eve' +
        'nto = ef.id_evento where ee.establecimiento = :esta and ee.tipo ' +
        '= 47 and (ta.id_rp like :rp or ta.nombre like :nombre or ta.id_h' +
        'ba like :hba) and ef.cantidad_embriones > 0')
    Left = 196
    Top = 32
    ParamData = <
      item
    ...
    object IBQDonantesID_ANIMAL: TIntegerField
      FieldName = 'ID_ANIMAL'
      Origin = 'TAB_ANIMALES.ID_ANIMAL'
      Required = True
    end
    object IBQDonantesID_RP: TIBStringField
      FieldName = 'ID_RP'
      Origin = 'TAB_ANIMALES.ID_RP'
      Required = True
      Size = 10
    end
    object IBQDonantesNOMBRE: TIBStringField
      FieldName = 'NOMBRE'
      Origin = 'TAB_ANIMALES.NOMBRE'
      Size = 50
    end
    object IBQDonantesID_HBA: TIBStringField
      FieldName = 'ID_HBA'
      Origin = 'TAB_ANIMALES.ID_HBA'
      Size = 10
    end
    object IBQDonantesRAZA: TIntegerField
      FieldName = 'RAZA'
      Origin = 'TAB_ANIMALES.RAZA'
      Required = True
    end
    object IBQDonantesTIPIFICACION_SANGUINEA: TIBStringField
      FieldName = 'TIPIFICACION_SANGUINEA'
      Origin = 'TAB_ANIMALES.TIPIFICACION_SANGUINEA'
      Size = 255
    end
    object IBQDonantesNOMBRE_COM: TIBStringField
      FieldKind = fkCalculated
      FieldName = 'NOMBRE_COM'
      Size = 100
      Calculated = True
    end
    object IBQDonantesNOM_RAZA: TStringField
      FieldKind = fkLookup
      FieldName = 'NOM_RAZA'
      LookupDataSet = DMSoftvet.IBQRaza
      LookupKeyFields = 'ID_RAZA'
      LookupResultField = 'NOMBRE'
      KeyFields = 'RAZA'
      Size = 50
      Lookup = True
    end
    object IBQDonantesCRIADOR: TIntegerField
      FieldName = 'CRIADOR'
      Origin = 'TAB_ANIMALES.CRIADOR'
    end
    object IBQDonantesNOM_CRIADOR: TStringField
      FieldKind = fkLookup
      FieldName = 'NOM_CRIADOR'
      LookupDataSet = IBQCriador
      LookupKeyFields = 'ID_CRIADOR'
      LookupResultField = 'NOMBRE'
      KeyFields = 'CRIADOR'
      Size = 50
      Lookup = True
  ...
  object IBQDatosColecta: TIBQuery
    Database = FPrincipal.IBDPrincipal
    Transaction = FPrincipal.IBTPrincipal
    AfterOpen = IBQDatosColectaAfterOpen
    BufferChunks = 1000
    CachedUpdates = False
    SQL.Strings = (
      'select * from get_datos_colecta(:animal,:establecimiento)')
    Left = 268
    Top = 33
    ParamData = <
      item
    ...
    object IBQDatosColectaNOMBRE_P1: TIBStringField
      FieldName = 'NOMBRE_P1'
      Origin = 'GET_DATOS_COLECTA.NOMBRE_P1'
      Size = 50
    end
    object IBQDatosColectaNOMBRE_P2: TIBStringField
      FieldName = 'NOMBRE_P2'
      Origin = 'GET_DATOS_COLECTA.NOMBRE_P2'
      Size = 50
    end
    object IBQDatosColectaRP_P1: TIBStringField
      FieldName = 'RP_P1'
      Origin = 'GET_DATOS_COLECTA.RP_P1'
      Size = 10
    end
    object IBQDatosColectaRP_P2: TIBStringField
      FieldName = 'RP_P2'
      Origin = 'GET_DATOS_COLECTA.RP_P2'
      Size = 10
    end
    object IBQDatosColectaHBA_P1: TIBStringField
      FieldName = 'HBA_P1'
      Origin = 'GET_DATOS_COLECTA.HBA_P1'
      Size = 10
    end
    object IBQDatosColectaHBA_P2: TIBStringField
      FieldName = 'HBA_P2'
      Origin = 'GET_DATOS_COLECTA.HBA_P2'
      Size = 10
    end
    object IBQDatosColectaTIPO_SANG_P1: TIBStringField
      FieldName = 'TIPO_SANG_P1'
      Origin = 'GET_DATOS_COLECTA.TIPO_SANG_P1'
      Size = 255
    end
    object IBQDatosColectaTIPO_SANG_P2: TIBStringField
      FieldName = 'TIPO_SANG_P2'
      Origin = 'GET_DATOS_COLECTA.TIPO_SANG_P2'
      Size = 255
    end
    object IBQDatosColectaNOM_SERVICIO: TIBStringField
      FieldName = 'NOM_SERVICIO'
      Origin = 'GET_DATOS_COLECTA.NOM_SERVICIO'
      Size = 50
    end
    object IBQDatosColectaFECHA_SERVICIO: TDateField
      FieldName = 'FECHA_SERVICIO'
      Origin = 'GET_DATOS_COLECTA.FECHA_SERVICIO'
    end
    object IBQDatosColectaFECHA_COLECTA: TDateField
      FieldName = 'FECHA_COLECTA'
      Origin = 'GET_DATOS_COLECTA.FECHA_COLECTA'
    end
    object IBQDatosColectaCANT_EMBRIONES_TE: TIntegerField
      FieldName = 'CANT_EMBRIONES_TE'
      Origin = 'GET_DATOS_COLECTA.CANT_EMBRIONES_TE'
    end
    object IBQDatosColectaCANT_EMBRIONES_NF: TIntegerField
      FieldName = 'CANT_EMBRIONES_NF'
      Origin = 'GET_DATOS_COLECTA.CANT_EMBRIONES_NF'
    end
    object IBQDatosColectaCANT_EMBRIONES_DEG: TIntegerField
      FieldName = 'CANT_EMBRIONES_DEG'
      Origin = 'GET_DATOS_COLECTA.CANT_EMBRIONES_DEG'
    end
    object IBQDatosColectaCANT_EMBRIONES_TR: TIntegerField
      FieldName = 'CANT_EMBRIONES_TR'
      Origin = 'GET_DATOS_COLECTA.CANT_EMBRIONES_TR'
    end
    object IBQDatosColectaID_P1: TIntegerField
      FieldName = 'ID_P1'
      Origin = 'GET_DATOS_COLECTA.ID_P1'
    end
    object IBQDatosColectaID_P2: TIntegerField
      FieldName = 'ID_P2'
      Origin = 'GET_DATOS_COLECTA.ID_P2'
    end
    object IBQDatosColectaCENTRO_TRANSPLANTE: TIntegerField
      FieldName = 'CENTRO_TRANSPLANTE'
      Origin = 'GET_DATOS_COLECTA.CENTRO_TRANSPLANTE'
    end
    object IBQDatosColectaNOM_CENTRO: TStringField
      FieldKind = fkLookup
      FieldName = 'NOM_CENTRO'
      LookupDataSet = IBQCentrosTransplante
    ...
    object IBQDatosColectaHAB_CENTRO: TStringField
      FieldKind = fkLookup
      FieldName = 'HAB_CENTRO'
      LookupDataSet = IBQCentrosTransplante
      LookupKeyFields = 'ID_CENTRO_TRANSPLANTE'
    ...
    object IBQDatosColectaNRO_INSC: TStringField
      FieldKind = fkLookup
      FieldName = 'NRO_INSC'
      LookupDataSet = IBQCentrosTransplante
      LookupKeyFields = 'ID_CENTRO_TRANSPLANTE'
      LookupResultField = 'NRO_INSCRIPCION'
      KeyFields = 'CENTRO_TRANSPLANTE'
      Size = 50
      Lookup = True
    end
    object IBQDatosColectaCONGELADOS: TIntegerField
      FieldName = 'CONGELADOS'
      Origin = 'GET_DATOS_COLECTA.CONGELADOS'
    end
    object IBQDatosColectaFRESCOS: TIntegerField
      FieldName = 'FRESCOS'
      Origin = 'GET_DATOS_COLECTA.FRESCOS'
    end
  end
  object DSDatosColecta: TDataSource
    DataSet = IBQDatosColecta
    Left = 300
    Top = 33
  end
  object IBDSReceptoras: TIBDataSet
    Database = FPrincipal.IBDPrincipal
    Transaction = FPrincipal.IBTPrincipal
    BufferChunks = 1000
    CachedUpdates = False
    ...
    InsertSQL.Strings = (
      'insert into aux_animales'
        ...
        '  (ID_ANIMAL, ID_RP, NOMBRE, RAZA, POTRERO, LOTE, RODEO, CATEGOR' +
        'IA, ADN, '
      '   FECHA_NACIMIENTO)'
      'values'
      
        '  (:ID_ANIMAL, :ID_RP, :NOMBRE, :RAZA, :POTRERO, :LOTE, :RODEO, ' +
        ':CATEGORIA, '
      '   :ADN, :FECHA_NACIMIENTO)')
    RefreshSQL.Strings = (
      'Select *'
      'from aux_animales '
      'where'
    ...
    SelectSQL.Strings = (
        ...
        'select id_animal, id_rp, nombre,raza, potrero, lote, rodeo, cate' +
        'goria, adn, fecha_nacimiento  from aux_animales')
    ModifySQL.Strings = (
      'update aux_animales'
      'set'
      '  ID_ANIMAL = :ID_ANIMAL,'
    ...
    Left = 404
    Top = 56
    object IBDSReceptorasID_ANIMAL: TIntegerField
      FieldName = 'ID_ANIMAL'
      Origin = 'AUX_ANIMALES.ID_ANIMAL'
      Required = True
    end
    object IBDSReceptorasID_RP: TIBStringField
      FieldName = 'ID_RP'
      Origin = 'AUX_ANIMALES.ID_RP'
      Size = 10
    end
    object IBDSReceptorasNOMBRE: TIBStringField
      FieldName = 'NOMBRE'
      Origin = 'AUX_ANIMALES.NOMBRE'
      Size = 50
    end
    object IBDSReceptorasPOTRERO: TIntegerField
      FieldName = 'POTRERO'
      Origin = 'AUX_ANIMALES.POTRERO'
    end
    object IBDSReceptorasLOTE: TIntegerField
      FieldName = 'LOTE'
      Origin = 'AUX_ANIMALES.LOTE'
    end
    object IBDSReceptorasRODEO: TIntegerField
      FieldName = 'RODEO'
      Origin = 'AUX_ANIMALES.RODEO'
    end
    object IBDSReceptorasCATEGORIA: TIntegerField
      FieldName = 'CATEGORIA'
      Origin = 'AUX_ANIMALES.CATEGORIA'
    end
    object IBDSReceptorasADN: TIBStringField
      FieldName = 'ADN'
      Origin = 'AUX_ANIMALES.ADN'
      Size = 255
    end
    object IBDSReceptorasRAZA: TIntegerField
      FieldName = 'RAZA'
      Origin = 'AUX_ANIMALES.RAZA'
    end
    object IBDSReceptorasCOD_RAZA: TStringField
      FieldKind = fkLookup
      FieldName = 'COD_RAZA'
      LookupDataSet = DMSoftvet.IBQRaza
      LookupKeyFields = 'ID_RAZA'
    ...
    object IBDSReceptorasNCALIDAD: TIntegerField
      FieldKind = fkLookup
      FieldName = 'NCALIDAD'
    ...
    object IBDSReceptorasNESTADIO: TIntegerField
      FieldKind = fkLookup
      FieldName = 'NESTADIO'
    ...
    object IBDSReceptorasFECHA_NACIMIENTO: TDateField
      FieldName = 'FECHA_NACIMIENTO'
      Origin = 'AUX_ANIMALES.FECHA_NACIMIENTO'
    end
  end
  object DSReceptoras: TDataSource
    DataSet = IBDSReceptoras
    Left = 372
    Top = 56
  end
  ...
  object IBDSEmbriones: TIBDataSet
    Database = FPrincipal.IBDPrincipal
    Transaction = FPrincipal.IBTPrincipal
    BufferChunks = 1000
    CachedUpdates = False
    ...
    InsertSQL.Strings = (
      'insert into aux_embriones'
        ...
        '  (ID_EMBRION, FECHA_COLECCION, DESTINO, SERIE, NRO_ENVASE, ID_E' +
        'STADIO, '
      '   ID_CALIDAD, CANT_LAVAJES, NRO_ORDEN)'
      'values'
      
        '  (:ID_EMBRION, :FECHA_COLECCION, :DESTINO, :SERIE, :NRO_ENVASE,' +
        ' :ID_ESTADIO, '
      '   :ID_CALIDAD, :CANT_LAVAJES, :NRO_ORDEN)')
    RefreshSQL.Strings = (
      'Select *'
    ...
    Left = 572
    Top = 424
    object IBDSEmbrionesID_EMBRION: TIntegerField
      FieldName = 'ID_EMBRION'
      Origin = 'AUX_EMBRIONES.ID_EMBRION'
    end
    object IBDSEmbrionesESTABLECIMIENTO: TIntegerField
      FieldName = 'ESTABLECIMIENTO'
      Origin = 'AUX_EMBRIONES.ESTABLECIMIENTO'
    end
    object IBDSEmbrionesFECHA_COLECCION: TDateField
      FieldName = 'FECHA_COLECCION'
      Origin = 'AUX_EMBRIONES.FECHA_COLECCION'
    end
    object IBDSEmbrionesID_DESTINO: TIntegerField
      FieldName = 'ID_DESTINO'
      Origin = 'AUX_EMBRIONES.ID_DESTINO'
    end
    object IBDSEmbrionesDESTINO: TIBStringField
      FieldName = 'DESTINO'
      Origin = 'AUX_EMBRIONES.DESTINO'
      Size = 50
    end
    object IBDSEmbrionesID_DESCRIPCION: TIntegerField
      FieldName = 'ID_DESCRIPCION'
      Origin = 'AUX_EMBRIONES.ID_DESCRIPCION'
    end
    object IBDSEmbrionesDESCRIPCION: TIBStringField
      FieldName = 'DESCRIPCION'
      Origin = 'AUX_EMBRIONES.DESCRIPCION'
      Size = 50
    end
    object IBDSEmbrionesSERIE: TIBStringField
      FieldName = 'SERIE'
      Origin = 'AUX_EMBRIONES.SERIE'
    end
    object IBDSEmbrionesNRO_ENVASE: TIBStringField
      FieldName = 'NRO_ENVASE'
      Origin = 'AUX_EMBRIONES.NRO_ENVASE'
      Size = 25
    end
    object IBDSEmbrionesID_ESTADIO: TIntegerField
      FieldName = 'ID_ESTADIO'
      Origin = 'AUX_EMBRIONES.ID_ESTADIO'
    end
    object IBDSEmbrionesESTADIO: TIBStringField
      FieldName = 'ESTADIO'
      Origin = 'AUX_EMBRIONES.ESTADIO'
      Size = 50
    end
    object IBDSEmbrionesID_CALIDAD: TIntegerField
      FieldName = 'ID_CALIDAD'
      Origin = 'AUX_EMBRIONES.ID_CALIDAD'
    end
    object IBDSEmbrionesCALIDAD: TIBStringField
      FieldName = 'CALIDAD'
      Origin = 'AUX_EMBRIONES.CALIDAD'
      Size = 50
    end
    object IBDSEmbrionesID_RESP: TIntegerField
      FieldName = 'ID_RESP'
      Origin = 'AUX_EMBRIONES.ID_RESP'
    end
    object IBDSEmbrionesRESPONSABLE: TIBStringField
      FieldName = 'RESPONSABLE'
      Origin = 'AUX_EMBRIONES.RESPONSABLE'
      Size = 50
    end
    object IBDSEmbrionesOBSERVACION: TIBStringField
      FieldName = 'OBSERVACION'
      Origin = 'AUX_EMBRIONES.OBSERVACION'
      Size = 255
    end
    object IBDSEmbrionesMADRE: TIntegerField
      FieldName = 'MADRE'
      Origin = 'AUX_EMBRIONES.MADRE'
    end
    object IBDSEmbrionesPADRE_1: TIntegerField
      FieldName = 'PADRE_1'
      Origin = 'AUX_EMBRIONES.PADRE_1'
    end
    object IBDSEmbrionesPADRE_2: TIntegerField
      FieldName = 'PADRE_2'
      Origin = 'AUX_EMBRIONES.PADRE_2'
    end
    object IBDSEmbrionesPADRE_EXTERNO_1: TIBStringField
      FieldName = 'PADRE_EXTERNO_1'
      Origin = 'AUX_EMBRIONES.PADRE_EXTERNO_1'
      Size = 1
    end
    object IBDSEmbrionesPADRE_EXTERNO_2: TIBStringField
      FieldName = 'PADRE_EXTERNO_2'
      Origin = 'AUX_EMBRIONES.PADRE_EXTERNO_2'
      Size = 1
    end
    object IBDSEmbrionesMADRE_INTERNA: TIBStringField
      FieldName = 'MADRE_INTERNA'
      Origin = 'AUX_EMBRIONES.MADRE_INTERNA'
      Size = 1
    end
    object IBDSEmbrionesUSADO: TIBStringField
      FieldName = 'USADO'
      Origin = 'AUX_EMBRIONES.USADO'
      Size = 1
    end
    object IBDSEmbrionesCANT_LAVAJES: TIntegerField
      FieldName = 'CANT_LAVAJES'
      Origin = 'AUX_EMBRIONES.CANT_LAVAJES'
    end
    object IBDSEmbrionesPRECIO: TFloatField
      FieldName = 'PRECIO'
      Origin = 'AUX_EMBRIONES.PRECIO'
    end
    object IBDSEmbrionesCENTRO_TRANSPLANTE: TIntegerField
      FieldName = 'CENTRO_TRANSPLANTE'
      Origin = 'AUX_EMBRIONES.CENTRO_TRANSPLANTE'
    end
    object IBDSEmbrionesDIAS_GESTACION: TIntegerField
      FieldName = 'DIAS_GESTACION'
      Origin = 'AUX_EMBRIONES.DIAS_GESTACION'
    end
    object IBDSEmbrionesNRO_ORDEN: TIBStringField
      FieldName = 'NRO_ORDEN'
      Origin = 'AUX_EMBRIONES.NRO_ORDEN'
      Size = 12
    end
    object IBDSEmbrionesNOMEST: TIntegerField
      FieldKind = fkLookup
      FieldName = 'NOMEST'
      LookupDataSet = IBQEstadio
      LookupKeyFields = 'ID_ESTADIO'
      LookupResultField = 'VALOR'
      KeyFields = 'ID_ESTADIO'
      Lookup = True
    end
    object IBDSEmbrionesNOMCALIDAD: TIntegerField
      FieldKind = fkLookup
      FieldName = 'NOMCALIDAD'
      LookupDataSet = IBQCalidad
      LookupKeyFields = 'ID_CALIDAD'
      LookupResultField = 'VALOR'
      KeyFields = 'ID_CALIDAD'
      Lookup = True
    end
  end
  object IBQEmbriones: TIBQuery
    Database = FPrincipal.IBDPrincipal
    Transaction = FPrincipal.IBTPrincipal
    AfterOpen = IBQEmbrionesAfterOpen
    BufferChunks = 1000
    CachedUpdates = False
    SQL.Strings = (
      
        'select id_embrion, serie, nro_envase, cant_lavajes, estadio, cal' +
        'idad'
      'from tab_embriones'
      '     where madre = :madre and establecimiento = :esta and'
      '           fecha_coleccion = :fecha_colecta'
      '')
    Left = 612
    Top = 424
    ParamData = <
  ...
  object DSEmbriones: TDataSource
    DataSet = IBDSEmbriones
    Left = 572
    Top = 456
  end
  object IBQDescDestinos: TIBQuery
    Database = FPrincipal.IBDPrincipal
    Transaction = FPrincipal.IBTPrincipal
    AfterOpen = IBQDescDestinosAfterOpen
    BufferChunks = 1000
    CachedUpdates = False
    SQL.Strings = (
  ...
  object DSDescDestinos: TDataSource
    DataSet = IBQDescDestinos
    Left = 604
    Top = 392
  end
