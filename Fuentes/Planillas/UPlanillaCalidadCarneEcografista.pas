unit UPlanillaCalidadCarneEcografista;
...
type
  TFPlanillaCalidadCarneEcografista = class(TFPlanillaUniversal)
    QRLabel1: TQRLabel;
    QRLabel6: TQRLabel;
    QRLabel7: TQRLabel;
    QRLabel2: TQRLabel;
...
var
  FPlanillaCalidadCarneEcografista: TFPlanillaCalidadCarneEcografista;

implementation

{$R *.dfm}

procedure TFPlanillaCalidadCarneEcografista.PasarAnimales;
begin
end;

procedure TFPlanillaCalidadCarneEcografista.ConfigurarReporte;
begin
