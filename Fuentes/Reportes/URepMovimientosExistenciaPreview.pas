unit URepMovimientosExistenciaPreview;
...
uses
  ...
  IBStoredProc, ActnList, ComCtrls, StdCtrls, ExtCtrls, jpeg, QRCtrls,
  QuickRpt, IBQuery, ImgList, PngImageList, pngimage, JvExExtCtrls,
  JvImage, JvExControls, JvLabel, JvGIF;

type
  TFRepMovimientoExistenciaPreview = class(TFUniversal)
    QRMovimientosExistencia: TQuickRep;
...
var
  FRepMovimientoExistenciaPreview: TFRepMovimientoExistenciaPreview;

implementation

uses UPrincipal,uTiposGlobales, URepMovimientosExistencia, URepGeneral;

{$R *.dfm}

procedure TFRepMovimientoExistenciaPreview.QRBEncabezadoPlanillaBeforePrint(
...
procedure TFRepMovimientoExistenciaPreview.FormShow(Sender: TObject);
var
  H : HWND;
begin
  inherited;
  QRMovimientosExistencia.Preview;
...
procedure TFRepMovimientoExistenciaPreview.cargarDatosPropietario;
var
