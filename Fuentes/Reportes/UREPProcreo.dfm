inherited FREPProcreo: TFREPProcreo
  Left = 281
  Top = 101
  Caption = 'FREPProcreo'
  ClientHeight = 647
  ...
  object GBServicios: TGroupBox [6]
    Left = 397
    Top = 203
    Width = 504
    Height = 241
    Align = alClient
    Caption = ' Servicios Involucrados '
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clWindowText
    Font.Height = -13
    Font.Name = 'Arial'
  ...
  object GBObservaciones: TGroupBox [7]
    Left = 0
    Top = 444
    Width = 901
    Height = 66
  ...
  object GBFiltros: TGroupBox [8]
    ...
    object CBAServicio: TComboBoxAuto
      Left = 153
      Top = 42
      Width = 200
      Height = 26
      ...
      ParentFont = False
      TabOrder = 0
      Text = 'SERVICIO PRIMAVERA'
      OnChange = CBAServicioChange
      Items.Strings = (
        'SERVICIO PRIMAVERA'
        'SERVICIO OTO'#209'O')
      EsClave = False
    ...
    object CBCompra: TCheckBox
      Left = 16
      Top = 101
      Width = 357
      Height = 19
      Caption = 'Agregar animales comprados en el periodo'
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clWindowText
      Font.Height = -16
      Font.Name = 'Arial'
    ...
    object DTPHasta: TDateTimePicker
      ...
      Width = 113
      Height = 24
      Date = 40725.431692372690000000
      Time = 40725.431692372690000000
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clWindowText
      Font.Height = -13
      Font.Name = 'Arial'
  ...
  object IBQTipoServicios: TIBQuery
    ...
    SQL.Strings = (
        ...
        'MIENTO = :ESTA AND PARAMETRO =:PARAM')
    Left = 168
    Top = 48
    ParamData = <
      item
  ...
  object IBQREPProcreo: TIBQuery
    Database = FPrincipal.IBDPrincipal
    Transaction = FPrincipal.IBTPrincipal
    BufferChunks = 1000
    CachedUpdates = False
    SQL.Strings = (
      'select * from REP_PROCREO(:ESTA,:FECHA_INI,:FECHA_FIN)')
    Left = 384
    Top = 393
    ParamData = <
      item
  ...
  object IBQServicios: TIBQuery
    ...
    SQL.Strings = (
        ...
        'select nombre, fecha_inicio, fecha_fin, tipo from tab_servicios ' +
        'where fecha_inicio between :fecha_ini and :fecha_fin and estable' +
        'cimiento = :esta')
    Left = 352
    Top = 425
    ParamData = <
  ...
  object DSREPProcreo: TDataSource
    DataSet = IBQREPAnimales
    Left = 352
    Top = 393
  end
  object IBQProcreoNoRelac: TIBQuery
    Database = FPrincipal.IBDPrincipal
    Transaction = FPrincipal.IBTPrincipal
    BufferChunks = 1000
    CachedUpdates = False
    SQL.Strings = (
      'select * from REP_PROCREO_NO_RELAC(:esta, :desde, :hasta)')
    Left = 417
    Top = 393
    ParamData = <
      item
  ...
  object IBQREPProcreoCompra: TIBQuery
    Database = FPrincipal.IBDPrincipal
    Transaction = FPrincipal.IBTPrincipal
    BufferChunks = 1000
    CachedUpdates = False
    SQL.Strings = (
        ...
        'select * from rep_procreo_compra(:fecha_min_serv,:fecha_max_serv' +
        ',:fecha_max_tacto, :esta)')
    Left = 384
    Top = 424
    ParamData = <
      item
  ...
  object IBQREPProcreoCompraTer: TIBQuery
    Database = FPrincipal.IBDPrincipal
    Transaction = FPrincipal.IBTPrincipal
    BufferChunks = 1000
    CachedUpdates = False
    SQL.Strings = (
        ...
        'select * from rep_procreo_compra_ter(:fecha_ini, :fecha_fin, :es' +
        'ta)')
    Left = 417
    Top = 425
    ParamData = <
  ...
  object IBQREPAnimales: TIBQuery
    Database = FPrincipal.IBDPrincipal
    Transaction = FPrincipal.IBTPrincipal
    AfterOpen = IBQREPAnimalesAfterOpen
    OnCalcFields = IBQREPAnimalesCalcFields
    BufferChunks = 1000
    CachedUpdates = False
    SQL.Strings = (
      
        'select id_animal, rp_animal, fecha_nacimiento, estado  from rep_' +
        'procreo_animales(:fecha_ini, :fecha_fin, :esta,:compra) order by' +
        ' rp_animal asc')
    Left = 377
    Top = 345
    ParamData = <
    ...
    object IBQREPAnimalesID_ANIMAL: TIntegerField
      FieldName = 'ID_ANIMAL'
      Origin = 'REP_PROCREO_ANIMALES.ID_ANIMAL'
    end
    object IBQREPAnimalesRP_ANIMAL: TIBStringField
      FieldName = 'RP_ANIMAL'
      Origin = 'REP_PROCREO_ANIMALES.RP_ANIMAL'
      Size = 10
    end
    object IBQREPAnimalesFECHA_NACIMIENTO: TDateField
      FieldName = 'FECHA_NACIMIENTO'
      Origin = 'REP_PROCREO_ANIMALES.FECHA_NACIMIENTO'
    end
    object IBQREPAnimalesESTADO: TIBStringField
      FieldName = 'ESTADO'
      Origin = 'REP_PROCREO_ANIMALES.ESTADO'
      Size = 1
    end
    object IBQREPAnimalesREFERENCIA: TStringField
