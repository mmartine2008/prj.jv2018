inherited FRepEntradasSalidasCarne: TFRepEntradasSalidasCarne
  Left = 373
  Top = 111
  Caption = 'FRepEntradasSalidasCarne'
  ClientHeight = 593
  ClientWidth = 554
  OldCreateOrder = True
  PixelsPerInch = 96
  ...
  object PDatosSalida: TPanel [4]
    ...
    Color = clWhite
    TabOrder = 4
    object GBDatosSalida: TGroupBox
      Left = 1
      Top = 1
      Width = 552
      Height = 139
      ...
      ParentFont = False
      TabOrder = 0
      object BDBGDatosSalida: TBitDBGrid
        Left = 2
        Top = 18
        Width = 548
        Height = 119
        Align = alClient
        DataSource = DSRepSalidas
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clWindowText
        Font.Height = -12
        ...
        TitleFont.Style = []
        OnDrawColumnCell = BDBGDatosSalidaDrawColumnCell
  ...
  object PDatosEntrada: TPanel [5]
    ...
    Color = clWhite
    TabOrder = 3
    object GBDatosEntrada: TGroupBox
      Left = 1
      Top = 1
      Width = 552
      Height = 188
      ...
      ParentFont = False
      TabOrder = 0
      object BDBGDatosEntrada: TBitDBGrid
        Left = 2
        Top = 18
        Width = 548
        Height = 168
        Align = alClient
        DataSource = DSRepEntradas
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clWindowText
        Font.Height = -12
        Font.Name = 'MS Sans Serif'
        ...
        TitleFont.Name = 'MS Sans Serif'
        TitleFont.Style = []
        OnDrawColumnCell = BDBGDatosEntradaDrawColumnCell
        AllowIncSearch = False
        ColumnVersion = 0
        DefaultColumns = True
        DrawingEllipse = True
  ...
  object PFiltros: TPanel [6]
    ...
    object GroupBox1: TGroupBox
      ...
      object DTPADesde: TDateTimePickerAuto
        ...
        Width = 138
        Height = 21
        Date = 39534.424157986110000000
        Time = 39534.424157986110000000
        Color = clWhite
        TabOrder = 0
        OnCloseUp = DTPACloseUp
  ...
  inherited DTXLS: TDataToXLS
    ...
    Title.Text = 'Costos Veterinarios'
    Left = 32
    Top = 9
  end
  ...
  object DSRepEntradas: TDataSource
    DataSet = IBDSEntradas
    Left = 113
    Top = 65
  end
  object IBDSEntradas: TIBDataSet
    ...
    InsertSQL.Strings = (
      ...
      '  (V2, V3, V4, I1, I2, I3, D1, ID_ANIMAL, ID_AUX_EVENTO, F1, F3)'
      'values'
      
        '  (:V2, :V3, :V4, :I1, :I2, :I3, :D1, :ID_ANIMAL, :ID_AUX_EVENTO' +
        ', :F1, '
      '   :F3)')
    RefreshSQL.Strings = (
      'Select *'
    ...
    Left = 145
    Top = 65
    object IBDSEntradasV7: TIBStringField
      FieldName = 'V7'
      Origin = 'AUX_EVENTOS.V7'
      Size = 100
    end
    object IBDSEntradasV10: TIBStringField
      FieldName = 'V10'
      Origin = 'AUX_EVENTOS.V10'
      Size = 100
    end
    object IBDSEntradasV6: TIBStringField
      FieldName = 'V6'
      Origin = 'AUX_EVENTOS.V6'
      Size = 100
    end
    object IBDSEntradasV5: TIBStringField
      FieldName = 'V5'
      Origin = 'AUX_EVENTOS.V5'
      Size = 100
    end
    object IBDSEntradasID_SENASA: TIBStringField
      FieldName = 'ID_SENASA'
      Origin = 'AUX_EVENTOS.ID_SENASA'
      Size = 9
    end
    object IBDSEntradasV9: TIBStringField
      FieldName = 'V9'
      Origin = 'AUX_EVENTOS.V9'
      Size = 100
    end
    object IBDSEntradasV8: TIBStringField
      FieldName = 'V8'
      Origin = 'AUX_EVENTOS.V8'
      Size = 100
    end
    object IBDSEntradasV11: TIBStringField
      FieldName = 'V11'
      Origin = 'AUX_EVENTOS.V11'
      Size = 100
    end
    object IBDSEntradasID_RP: TIBStringField
      FieldName = 'ID_RP'
      Origin = 'AUX_EVENTOS.ID_RP'
      Size = 10
    end
    object IBDSEntradasFECHA: TDateField
      FieldName = 'FECHA'
      Origin = 'AUX_EVENTOS.FECHA'
    end
    object IBDSEntradasOBSERVACION: TIBStringField
      FieldName = 'OBSERVACION'
      Origin = 'AUX_EVENTOS.OBSERVACION'
      Size = 255
    end
    object IBDSEntradasRESPONSABLE: TIntegerField
      FieldName = 'RESPONSABLE'
      Origin = 'AUX_EVENTOS.RESPONSABLE'
    end
    object IBDSEntradasV1: TIBStringField
      FieldName = 'V1'
      Origin = 'AUX_EVENTOS.V1'
      Size = 100
    end
    object IBDSEntradasV2: TIBStringField
      FieldName = 'V2'
      Origin = 'AUX_EVENTOS.V2'
      Size = 100
    end
    object IBDSEntradasNOMBRE: TIBStringField
      FieldName = 'NOMBRE'
      Origin = 'AUX_EVENTOS.NOMBRE'
      Size = 50
    end
    object IBDSEntradasV3: TIBStringField
      FieldName = 'V3'
      Origin = 'AUX_EVENTOS.V3'
      Size = 100
    end
    object IBDSEntradasV4: TIBStringField
      FieldName = 'V4'
      Origin = 'AUX_EVENTOS.V4'
      Size = 100
    end
    object IBDSEntradasI1: TIntegerField
      FieldName = 'I1'
      Origin = 'AUX_EVENTOS.I1'
    end
    object IBDSEntradasI2: TIntegerField
      FieldName = 'I2'
      Origin = 'AUX_EVENTOS.I2'
    end
    object IBDSEntradasI3: TIntegerField
      FieldName = 'I3'
      Origin = 'AUX_EVENTOS.I3'
    end
    object IBDSEntradasD1: TDateField
      FieldName = 'D1'
      Origin = 'AUX_EVENTOS.D1'
    end
    object IBDSEntradasD2: TDateField
      FieldName = 'D2'
      Origin = 'AUX_EVENTOS.D2'
    end
    object IBDSEntradasD3: TDateField
      FieldName = 'D3'
      Origin = 'AUX_EVENTOS.D3'
    end
    object IBDSEntradasID_ANIMAL: TIntegerField
      FieldName = 'ID_ANIMAL'
      Origin = 'AUX_EVENTOS.ID_ANIMAL'
    end
    object IBDSEntradasID_AUX_EVENTO: TIntegerField
      FieldName = 'ID_AUX_EVENTO'
      Origin = 'AUX_EVENTOS.ID_AUX_EVENTO'
    end
    object IBDSEntradasI4: TIntegerField
      FieldName = 'I4'
      Origin = 'AUX_EVENTOS.I4'
    end
    object IBDSEntradasI5: TIntegerField
      FieldName = 'I5'
      Origin = 'AUX_EVENTOS.I5'
    end
    object IBDSEntradasI6: TIntegerField
      FieldName = 'I6'
      Origin = 'AUX_EVENTOS.I6'
    end
    object IBDSEntradasI7: TIntegerField
      FieldName = 'I7'
      Origin = 'AUX_EVENTOS.I7'
    end
    object IBDSEntradasI8: TIntegerField
      FieldName = 'I8'
      Origin = 'AUX_EVENTOS.I8'
    end
    object IBDSEntradasI9: TIntegerField
      FieldName = 'I9'
      Origin = 'AUX_EVENTOS.I9'
    end
    object IBDSEntradasVUNO1: TIBStringField
      FieldName = 'VUNO1'
      Origin = 'AUX_EVENTOS.VUNO1'
      Size = 1
    end
    object IBDSEntradasVUNO2: TIBStringField
      FieldName = 'VUNO2'
      Origin = 'AUX_EVENTOS.VUNO2'
      Size = 1
    end
    object IBDSEntradasVUNO3: TIBStringField
      FieldName = 'VUNO3'
      Origin = 'AUX_EVENTOS.VUNO3'
      Size = 1
    end
    object IBDSEntradasVUNO4: TIBStringField
      FieldName = 'VUNO4'
      Origin = 'AUX_EVENTOS.VUNO4'
      Size = 1
    end
    object IBDSEntradasVUNO5: TIBStringField
      FieldName = 'VUNO5'
      Origin = 'AUX_EVENTOS.VUNO5'
      Size = 1
    end
    object IBDSEntradasVUNO6: TIBStringField
      FieldName = 'VUNO6'
      Origin = 'AUX_EVENTOS.VUNO6'
      Size = 1
    end
    object IBDSEntradasEW: TIBStringField
      FieldName = 'EW'
      Origin = 'AUX_EVENTOS.EW'
      Size = 1
    end
    object IBDSEntradasH1: TTimeField
      FieldName = 'H1'
      Origin = 'AUX_EVENTOS.H1'
    end
    object IBDSEntradasV12: TIBStringField
      FieldName = 'V12'
      Origin = 'AUX_EVENTOS.V12'
      Size = 100
    end
    object IBDSEntradasF1: TFloatField
      DisplayWidth = 10
      FieldName = 'F1'
      Origin = 'AUX_EVENTOS.F1'
      Precision = 5
    end
    object IBDSEntradasF2: TFloatField
      FieldName = 'F2'
      Origin = 'AUX_EVENTOS.F2'
      Precision = 5
    end
    object IBDSEntradasF3: TFloatField
      FieldName = 'F3'
      Origin = 'AUX_EVENTOS.F3'
      Precision = 5
    end
    object IBDSEntradasF4: TFloatField
      FieldName = 'F4'
      Origin = 'AUX_EVENTOS.F4'
    end
    object IBDSEntradasF5: TFloatField
      FieldName = 'F5'
      Origin = 'AUX_EVENTOS.F5'
    end
    object IBDSEntradasID_PC: TIBStringField
      FieldName = 'ID_PC'
      Origin = 'AUX_EVENTOS.ID_PC'
      Size = 10
    end
    object IBDSEntradasID_HBA: TIBStringField
      FieldName = 'ID_HBA'
      Origin = 'AUX_EVENTOS.ID_HBA'
      Size = 10
    end
    object IBDSEntradasID_RA: TIBStringField
      FieldName = 'ID_RA'
      Origin = 'AUX_EVENTOS.ID_RA'
      Size = 10
    end
    object IBDSEntradasID_OTRO: TIBStringField
      FieldName = 'ID_OTRO'
      Origin = 'AUX_EVENTOS.ID_OTRO'
      Size = 10
    end
    object IBDSEntradasAPODO: TIBStringField
      FieldName = 'APODO'
      Origin = 'AUX_EVENTOS.APODO'
      Size = 50
    end
    object IBDSEntradasDTA_BAJA: TIBStringField
      FieldName = 'DTA_BAJA'
      Origin = 'AUX_EVENTOS.DTA_BAJA'
      Size = 50
    end
  end
  object IBDSSalidas: TIBDataSet
    Database = FPrincipal.IBDPrincipal
    Transaction = FPrincipal.IBTPrincipal
    BufferChunks = 1000
    CachedUpdates = False
    ...
    InsertSQL.Strings = (
      'insert into aux_animales'
        ...
        '  (ID_AUX, ID_ANIMAL, V1, V2, V3, FECHA_ALTA, PRECIO_UNITARIO, P' +
        'RECIO_BRUTO, '
      '   ACTIVIDAD, CRIADOR, PROPIETARIO)'
      'values'
      
        '  (:ID_AUX, :ID_ANIMAL, :V1, :V2, :V3, :FECHA_ALTA, :PRECIO_UNIT' +
        'ARIO, :PRECIO_BRUTO, '
      '   :ACTIVIDAD, :CRIADOR, :PROPIETARIO)')
    RefreshSQL.Strings = (
      'Select *'
    ...
    Left = 185
    Top = 65
    object IBDSSalidasID_AUX: TIntegerField
      FieldName = 'ID_AUX'
      Origin = 'AUX_ANIMALES.ID_AUX'
      Required = True
    end
    object IBDSSalidasESTABLECIMIENTO: TIntegerField
      FieldName = 'ESTABLECIMIENTO'
      Origin = 'AUX_ANIMALES.ESTABLECIMIENTO'
    end
    object IBDSSalidasID_ANIMAL: TIntegerField
      FieldName = 'ID_ANIMAL'
      Origin = 'AUX_ANIMALES.ID_ANIMAL'
      Required = True
    end
    object IBDSSalidasID_RP: TIBStringField
      FieldName = 'ID_RP'
      Origin = 'AUX_ANIMALES.ID_RP'
      Size = 10
    end
    object IBDSSalidasID_SENASA: TIBStringField
      FieldName = 'ID_SENASA'
      Origin = 'AUX_ANIMALES.ID_SENASA'
      Size = 9
    end
    object IBDSSalidasID_PC: TIBStringField
      FieldName = 'ID_PC'
      Origin = 'AUX_ANIMALES.ID_PC'
      Size = 10
    end
    object IBDSSalidasID_HBA: TIBStringField
      FieldName = 'ID_HBA'
      Origin = 'AUX_ANIMALES.ID_HBA'
      Size = 10
    end
    object IBDSSalidasID_RA: TIBStringField
      FieldName = 'ID_RA'
      Origin = 'AUX_ANIMALES.ID_RA'
      Size = 10
    end
    object IBDSSalidasID_OTRO: TIBStringField
      FieldName = 'ID_OTRO'
      Origin = 'AUX_ANIMALES.ID_OTRO'
      Size = 10
    end
    object IBDSSalidasNOMBRE: TIBStringField
      FieldName = 'NOMBRE'
      Origin = 'AUX_ANIMALES.NOMBRE'
      Size = 50
    end
    object IBDSSalidasFECHA_NACIMIENTO: TDateField
      FieldName = 'FECHA_NACIMIENTO'
      Origin = 'AUX_ANIMALES.FECHA_NACIMIENTO'
    end
    object IBDSSalidasSEXO: TIntegerField
      FieldName = 'SEXO'
      Origin = 'AUX_ANIMALES.SEXO'
    end
    object IBDSSalidasPESO: TFloatField
      FieldName = 'PESO'
      Origin = 'AUX_ANIMALES.PESO'
    end
    object IBDSSalidasORIGEN: TIBStringField
      FieldName = 'ORIGEN'
      Origin = 'AUX_ANIMALES.ORIGEN'
    end
    object IBDSSalidasCIRCUNFERENCIA_ESCROTAL: TFloatField
      FieldName = 'CIRCUNFERENCIA_ESCROTAL'
      Origin = 'AUX_ANIMALES.CIRCUNFERENCIA_ESCROTAL'
    end
    object IBDSSalidasESTADO_REPRODUCTIVO: TIntegerField
      FieldName = 'ESTADO_REPRODUCTIVO'
      Origin = 'AUX_ANIMALES.ESTADO_REPRODUCTIVO'
    end
    object IBDSSalidasESTADO_LACTACION: TIntegerField
      FieldName = 'ESTADO_LACTACION'
      Origin = 'AUX_ANIMALES.ESTADO_LACTACION'
    end
    object IBDSSalidasPOTRERO: TIntegerField
      FieldName = 'POTRERO'
      Origin = 'AUX_ANIMALES.POTRERO'
    end
    object IBDSSalidasLOTE: TIntegerField
      FieldName = 'LOTE'
      Origin = 'AUX_ANIMALES.LOTE'
    end
    object IBDSSalidasRAZA: TIntegerField
      FieldName = 'RAZA'
      Origin = 'AUX_ANIMALES.RAZA'
    end
    object IBDSSalidasRODEO: TIntegerField
      FieldName = 'RODEO'
      Origin = 'AUX_ANIMALES.RODEO'
    end
    object IBDSSalidasCATEGORIA: TIntegerField
      FieldName = 'CATEGORIA'
      Origin = 'AUX_ANIMALES.CATEGORIA'
    end
    object IBDSSalidasACTIVO: TIBStringField
      FieldName = 'ACTIVO'
      Origin = 'AUX_ANIMALES.ACTIVO'
      Size = 1
    end
    object IBDSSalidasCRONOLOGIA_DENTARIA: TIntegerField
      FieldName = 'CRONOLOGIA_DENTARIA'
      Origin = 'AUX_ANIMALES.CRONOLOGIA_DENTARIA'
    end
    object IBDSSalidasCONDICION_CORPORAL: TIntegerField
      FieldName = 'CONDICION_CORPORAL'
      Origin = 'AUX_ANIMALES.CONDICION_CORPORAL'
    end
    object IBDSSalidasMADRE_BIOLOGICA_EXTERNA: TIntegerField
      FieldName = 'MADRE_BIOLOGICA_EXTERNA'
      Origin = 'AUX_ANIMALES.MADRE_BIOLOGICA_EXTERNA'
    end
    object IBDSSalidasMADRE_RECEPTORA_EXTERNA: TIntegerField
      FieldName = 'MADRE_RECEPTORA_EXTERNA'
      Origin = 'AUX_ANIMALES.MADRE_RECEPTORA_EXTERNA'
    end
    object IBDSSalidasGDR: TIntegerField
      FieldName = 'GDR'
      Origin = 'AUX_ANIMALES.GDR'
    end
    object IBDSSalidasPADRE_EXTERNO: TIntegerField
      FieldName = 'PADRE_EXTERNO'
      Origin = 'AUX_ANIMALES.PADRE_EXTERNO'
    end
    object IBDSSalidasMADRE_BIOLOGICA_INTERNA: TIntegerField
      FieldName = 'MADRE_BIOLOGICA_INTERNA'
      Origin = 'AUX_ANIMALES.MADRE_BIOLOGICA_INTERNA'
    end
    object IBDSSalidasMADRE_RECEPTORA_INTERNA: TIntegerField
      FieldName = 'MADRE_RECEPTORA_INTERNA'
      Origin = 'AUX_ANIMALES.MADRE_RECEPTORA_INTERNA'
    end
    object IBDSSalidasPADRE_INTERNO: TIntegerField
      FieldName = 'PADRE_INTERNO'
      Origin = 'AUX_ANIMALES.PADRE_INTERNO'
    end
    object IBDSSalidasAPODO: TIBStringField
      FieldName = 'APODO'
      Origin = 'AUX_ANIMALES.APODO'
      Size = 50
    end
    object IBDSSalidasV1: TIBStringField
      FieldName = 'V1'
      Origin = 'AUX_ANIMALES.V1'
      Size = 50
    end
    object IBDSSalidasV2: TIBStringField
      FieldName = 'V2'
      Origin = 'AUX_ANIMALES.V2'
      Size = 50
    end
    object IBDSSalidasV3: TIBStringField
      FieldName = 'V3'
      Origin = 'AUX_ANIMALES.V3'
      Size = 50
    end
    object IBDSSalidasV4: TIBStringField
      FieldName = 'V4'
      Origin = 'AUX_ANIMALES.V4'
      Size = 50
    end
    object IBDSSalidasV5: TIBStringField
      FieldName = 'V5'
      Origin = 'AUX_ANIMALES.V5'
      Size = 50
    end
    object IBDSSalidasV6: TIBStringField
      FieldName = 'V6'
      Origin = 'AUX_ANIMALES.V6'
      Size = 50
    end
    object IBDSSalidasEW: TIBStringField
      FieldName = 'EW'
      Origin = 'AUX_ANIMALES.EW'
      Size = 1
    end
    object IBDSSalidasDTA: TIBStringField
      FieldName = 'DTA'
      Origin = 'AUX_ANIMALES.DTA'
      Size = 50
    end
    object IBDSSalidasV7: TIBStringField
      FieldName = 'V7'
      Origin = 'AUX_ANIMALES.V7'
      Size = 50
    end
    object IBDSSalidasV8: TIBStringField
      FieldName = 'V8'
      Origin = 'AUX_ANIMALES.V8'
      Size = 50
    end
    object IBDSSalidasV9: TIBStringField
      FieldName = 'V9'
      Origin = 'AUX_ANIMALES.V9'
      Size = 50
    end
    object IBDSSalidasVUNO1: TIBStringField
      FieldName = 'VUNO1'
      Origin = 'AUX_ANIMALES.VUNO1'
      Size = 1
    end
    object IBDSSalidasTIPO_ALTA: TIBStringField
      FieldName = 'TIPO_ALTA'
      Origin = 'AUX_ANIMALES.TIPO_ALTA'
    end
    object IBDSSalidasFECHA_ALTA: TDateField
      FieldName = 'FECHA_ALTA'
      Origin = 'AUX_ANIMALES.FECHA_ALTA'
    end
    object IBDSSalidasOBSERVACION: TIBStringField
      FieldName = 'OBSERVACION'
      Origin = 'AUX_ANIMALES.OBSERVACION'
      Size = 300
    end
    object IBDSSalidasRESPONSABLE: TIBStringField
      FieldName = 'RESPONSABLE'
      Origin = 'AUX_ANIMALES.RESPONSABLE'
      Size = 80
    end
    object IBDSSalidasPRECIO_UNITARIO: TFloatField
      FieldName = 'PRECIO_UNITARIO'
      Origin = 'AUX_ANIMALES.PRECIO_UNITARIO'
    end
    object IBDSSalidasPRECIO_BRUTO: TFloatField
      FieldName = 'PRECIO_BRUTO'
      Origin = 'AUX_ANIMALES.PRECIO_BRUTO'
    end
    object IBDSSalidasGASTOS: TFloatField
      FieldName = 'GASTOS'
      Origin = 'AUX_ANIMALES.GASTOS'
    end
    object IBDSSalidasV10: TIBStringField
      FieldName = 'V10'
      Origin = 'AUX_ANIMALES.V10'
      Size = 50
    end
    object IBDSSalidasACTIVIDAD: TIntegerField
      FieldName = 'ACTIVIDAD'
      Origin = 'AUX_ANIMALES.ACTIVIDAD'
    end
    object IBDSSalidasID_IE: TIBStringField
      FieldName = 'ID_IE'
      Origin = 'AUX_ANIMALES.ID_IE'
      Size = 64
    end
    object IBDSSalidasADN: TIBStringField
      FieldName = 'ADN'
      Origin = 'AUX_ANIMALES.ADN'
      Size = 255
    end
    object IBDSSalidasTIPIFICACION_SANGUINEA: TIBStringField
      FieldName = 'TIPIFICACION_SANGUINEA'
      Origin = 'AUX_ANIMALES.TIPIFICACION_SANGUINEA'
      Size = 255
    end
    object IBDSSalidasCRIADOR: TIntegerField
      FieldName = 'CRIADOR'
      Origin = 'AUX_ANIMALES.CRIADOR'
    end
    object IBDSSalidasPROPIETARIO: TIntegerField
      FieldName = 'PROPIETARIO'
      Origin = 'AUX_ANIMALES.PROPIETARIO'
    end
    object IBDSSalidasORIGEN_ANIMAL: TIntegerField
      FieldName = 'ORIGEN_ANIMAL'
      Origin = 'AUX_ANIMALES.ORIGEN_ANIMAL'
    end
    object IBDSSalidasV11: TIBStringField
      FieldName = 'V11'
      Origin = 'AUX_ANIMALES.V11'
      Size = 50
    end
    object IBDSSalidasV12: TIBStringField
      FieldName = 'V12'
      Origin = 'AUX_ANIMALES.V12'
      Size = 50
    end
    object IBDSSalidasV13: TIBStringField
      FieldName = 'V13'
      Origin = 'AUX_ANIMALES.V13'
      Size = 50
    end
  end
  object DSRepSalidas: TDataSource
    DataSet = IBDSSalidas
    Left = 217
    Top = 65
  end
  object IBQRepEntradasSalidasCarne: TIBQuery
    Database = FPrincipal.IBDPrincipal
    Transaction = FPrincipal.IBTPrincipal
    BufferChunks = 1000
    CachedUpdates = False
    SQL.Strings = (
        ...
        'EXECUTE PROCEDURE REP_ENTRADAS_SALIDAS_CARNE(:PESO,:PRECIO,:TIPO' +
        ',:FECHA,:IDCATEGORIA,:IDALTABAJA)')
    Left = 176
    Top = 160
    ParamData = <
      item
