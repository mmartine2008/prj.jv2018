unit URepExistenciaRodeoPotreroPreview;
...
uses
  ...
  QuickRpt, QRExport, QRPDFFilt, IBQuery,
  ImgList, PngImageList, JvExControls, JvLabel, JvGIF, pngimage,
  JvExExtCtrls, JvImage;

type
  TFRepExistenciaRodeoPotreroPreview = class(TFUniversal)
    QRExistenciaRodeoPotrero: TQuickRep;
...
var
  FRepExistenciaRodeoPotreroPreview: TFRepExistenciaRodeoPotreroPreview;

implementation

uses UPrincipal,uTiposGlobales, URepGeneral, URepExistenciaRodeoPotrero;
{$R *.dfm}

procedure TFRepExistenciaRodeoPotreroPreview.QRBEncabezadoPlanillaBeforePrint(
...
procedure TFRepExistenciaRodeoPotreroPreview.FormShow(Sender: TObject);
var
  H : HWND;
begin
  inherited;
  QRExistenciaRodeoPotrero.Preview;
...
procedure TFRepExistenciaRodeoPotreroPreview.cargarDatosPropietario;
var
