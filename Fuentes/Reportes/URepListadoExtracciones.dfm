inherited FRepListadoExtracciones: TFRepListadoExtracciones
  Left = 249
  Top = 76
  Caption = 'Listado de Extracciones'
  ClientHeight = 695
  ClientWidth = 1008
  OldCreateOrder = True
  PixelsPerInch = 96
  ...
  object PFiltros: TPanel [4]
    ...
    object GBFiltros: TGroupBox
      ...
      object DTPDesde: TDateTimePicker
        ...
        Height = 24
        Cursor = crHandPoint
        Date = 40868.710769479170000000
        Time = 40868.710769479170000000
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clWindowText
        Font.Height = -13
        Font.Name = 'Arial'
      ...
      object DTPHasta: TDateTimePicker
        ...
        Height = 24
        Cursor = crHandPoint
        Date = 40868.710840543980000000
        Time = 40868.710840543980000000
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clWindowText
        Font.Height = -13
        Font.Name = 'Arial'
  ...
  object PCliente: TPanel [5]
    ...
    object GBDetalle: TGroupBox
      ...
      Height = 391
      Align = alClient
      Caption = '  Extracciones realizadas   '
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clWindowText
      Font.Height = -13
      Font.Name = 'Arial'
      ...
      object BDBGDetalle: TBitDBGrid
        ...
        Cursor = crHandPoint
        Align = alClient
        DataSource = DSListadoExtracciones
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clWindowText
        Font.Height = -13
        Font.Name = 'Arial'
        ...
        TitleFont.Style = []
        OnDblClick = BDBGDetalleDblClick
        ...
        Columns = <
          ...
          item
            Alignment = taCenter
            Expanded = False
            FieldName = 'APODO_TORO'
            Title.Alignment = taCenter
            Title.Caption = 'Apodo (Toro)'
            Title.Font.Charset = DEFAULT_CHARSET
            Title.Font.Color = clWindowText
          ...
          item
            ...
            Font.Style = []
            Title.Alignment = taCenter
            Title.Caption = 'Color Semen Extra'#237'do'
            Title.Font.Charset = DEFAULT_CHARSET
            Title.Font.Color = clWindowText
            Title.Font.Height = -12
            Title.Font.Name = 'Arial'
          ...
          item
            ...
            Font.Style = []
            Title.Alignment = taCenter
            Title.Caption = 'Vigor Semen Extra'#237'do'
            Title.Font.Charset = DEFAULT_CHARSET
            Title.Font.Color = clWindowText
            Title.Font.Height = -12
            Title.Font.Name = 'Arial'
          ...
          item
            ...
            Font.Style = []
            Title.Alignment = taCenter
            Title.Caption = 'M'#233'todo de Toma'
            Title.Font.Charset = DEFAULT_CHARSET
            Title.Font.Color = clWindowText
            Title.Font.Height = -12
            Title.Font.Name = 'Arial'
          ...
          item
            ...
            Font.Style = []
            Title.Alignment = taCenter
            Title.Caption = 'Concentraci'#243'n'
            Title.Font.Charset = DEFAULT_CHARSET
            Title.Font.Color = clWindowText
            Title.Font.Height = -12
            Title.Font.Name = 'Arial'
          ...
          item
            ...
            Font.Style = []
            Title.Alignment = taCenter
            Title.Caption = 'Espermas/Pajuela'
            Title.Font.Charset = DEFAULT_CHARSET
            Title.Font.Color = clWindowText
            Title.Font.Height = -12
            Title.Font.Name = 'Arial'
  ...
  inherited DTXLS: TDataToXLS
    DataSet = IBQListadoExtracciones
    Columns = <
      item
      ...
      item
        DataField = 'COLOR_RAZA_TORO'
        Title = 'Color (Toro)'
        Alignment = taCenter
      end
      item
        DataField = 'COLOR_SEMEN'
        Title = 'Color Semen Extraido'
        Alignment = taCenter
      end
      item
        DataField = 'VIGOR_SEMEN'
        Title = 'Vigor Semen Extraido'
        Alignment = taCenter
      end
      item
        DataField = 'METODO_TOMA'
        Title = 'Metodo de Toma'
        Alignment = taCenter
      end
      item
        DataField = 'AUX_VOLUMEN'
        Title = 'Volumen'
        Alignment = taCenter
      end
      item
        DataField = 'AUX_MILLONES'
        Title = 'Concentracion'
        Alignment = taCenter
      end
      item
        DataField = 'AUX_ESPERM'
        Title = 'Espermas/Pajuela'
        Alignment = taCenter
      end>
    Title.Font.Height = -19
    Title.Text = 'Listado de Extracciones'
    Left = 131
    Top = 47
  end
  ...
  object DSListadoExtracciones: TDataSource
    DataSet = IBQListadoExtracciones
    Left = 17
    Top = 446
  end
  object IBQListadoExtracciones: TIBQuery
    Database = FPrincipal.IBDPrincipal
    Transaction = FPrincipal.IBTPrincipal
    BufferChunks = 1000
    CachedUpdates = False
    SQL.Strings = (
      'select * from rep_listado_extracciones(:desde,:hasta,:esta)')
    Left = 49
    Top = 446
    ParamData = <
      item
  ...
  object IBQChequearEvento: TIBQuery
    Database = FPrincipal.IBDPrincipal
    Transaction = FPrincipal.IBTPrincipal
    BufferChunks = 1000
    CachedUpdates = False
    SQL.Strings = (
      'select congelo '
      'from eve_extraccion_semen '
      'where id_evento_extraccion = :evento')
    Left = 369
    Top = 74
    ParamData = <
      item
