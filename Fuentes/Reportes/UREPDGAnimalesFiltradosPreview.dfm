inherited FREPDGAnimalesFiltradosPreview: TFREPDGAnimalesFiltradosPreview
  Left = 44
  Top = 195
  Caption = 'FREPDGAnimalesFiltradosPreview'
  ClientHeight = 411
  ClientWidth = 957
  OldCreateOrder = True
  Scaled = False
  ...
  object QRContenido: TQuickRep [4]
    Left = 104
    Top = 33
    Width = 794
    Height = 1123
    ...
    BeforePrint = QRContenidoBeforePrint
    DataSet = FREPDGAnimalesFiltrados.IBQAnimales
    ...
    object QRBand2: TQRBand
      ...
      Size.Values = (
        ...
        1899.708333333333000000)
      BandType = rbDetail
      object QRDBTRPAnimal: TQRDBText
        Left = 16
        Top = 1
        Width = 59
        Height = 15
      ...
      object QRDBDiasActuales: TQRDBText
        Left = 160
        Top = 1
        Width = 86
        Height = 15
      ...
      object QRDBDistribucion: TQRDBText
        Left = 497
        Top = 1
        Width = 44
        Height = 15
      ...
      object QRDBDiasTacto: TQRDBText
        Left = 343
        Top = 1
        Width = 86
        Height = 15
    ...
    object QRGroup1: TQRGroup
      ...
      object QRLabel2: TQRLabel
        ...
        AutoSize = True
        AutoStretch = False
        Caption = 'D'#237'as de gestaci'#243'n al '
        Color = clWhite
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clWindowText
        Font.Height = -13
