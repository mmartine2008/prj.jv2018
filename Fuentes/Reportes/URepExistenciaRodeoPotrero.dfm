inherited FREPExistenciaRodeoPotrero: TFREPExistenciaRodeoPotrero
  Left = 95
  Top = 82
  Caption = 'FREPExistenciaRodeoPotrero'
  ClientHeight = 558
  ClientWidth = 814
  OldCreateOrder = True
  OnClose = FormClose
  ...
  object PSeleccion: TPanel [4]
    ...
    Color = clWhite
    TabOrder = 4
    inline FrameRodeoPotrero: TFrameSeleccion
      Left = 1
      Top = 1
      Width = 812
      Height = 210
      ...
      inherited PSeleccion: TPanel
        ...
        inherited PBotones: TPanel
          ...
          inherited BBAgregarTodos: TJvImage
            ...
            Width = 69
            Height = 60
            OnClick = FrameRodeoPotreroBBAgregarTodosClick
          end
          inherited BBAgregarUno: TJvImage
            ...
            Width = 69
            Height = 58
            OnClick = FrameRodeoPotreroBBAgregarUnoClick
          end
          inherited BBEliminarUno: TJvImage
            ...
            Width = 69
            Height = 57
            OnClick = FrameRodeoPotreroBBEliminarUnoClick
          end
          inherited BBEliminarTodos: TJvImage
            ...
            Width = 69
            Height = 63
            OnClick = FrameRodeoPotreroBBEliminarTodosClick
          end
      ...
      inherited IBQDisponibles: TIBQuery
        AfterOpen = FrameRodeoPotreroIBQDisponiblesAfterOpen
        BeforeOpen = FrameRodeoPotreroIBQDisponiblesBeforeOpen
        SQL.Strings = (
      ...
      inherited IBQSeleccionados: TIBQuery
        BeforeOpen = FrameRodeoPotreroIBQSeleccionadosBeforeOpen
        SQL.Strings = (
  ...
  object PExistenciaRodeoPotrero: TPanel [5]
    Left = 0
    Top = 342
    Width = 814
    Height = 98
    ...
    TabOrder = 3
    Visible = False
    object GBExistRodeoPotrero: TGroupBox
      Left = 1
      Top = 1
      Width = 812
      Height = 96
      ...
      ParentFont = False
      TabOrder = 0
      object BDBGExistenciaRodeoPotrero: TBitDBGrid
        Left = 2
        Top = 18
        Width = 808
        Height = 76
        Align = alClient
        DataSource = DSExistRodeoPotrero
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clWindowText
        Font.Height = -12
        ...
        Columns = <
          ...
          item
            Expanded = False
            FieldName = 'CANTTERNERO'
            Title.Caption = 'Cant. Terneros'
            Width = 80
            Visible = True
          end
          item
            Expanded = False
            FieldName = 'CANTNOVILLO'
            Title.Caption = 'Cant. Novillos'
            Width = 80
            Visible = True
          end
          item
            Expanded = False
            FieldName = 'CANTTORO'
            Title.Caption = 'Cant. Toros'
            Visible = True
          end
          item
            Expanded = False
            FieldName = 'CANTTERNERA'
            Title.Caption = 'Cant. Terneras'
            Width = 80
            Visible = True
          end
          item
            Expanded = False
            FieldName = 'CANTVAQUILLONA'
            Title.Caption = 'Cant. Vaquillonas'
            Width = 90
            Visible = True
          end
          item
  ...
  inherited PTitulo: TPanel
    Width = 814
    Caption = 'Existencia Rodeo / Potrero'
  ...
  inherited DTXLS: TDataToXLS
    ...
    Columns = <
      ...
      item
        DataField = 'CANTTERNERO'
        Title = 'Cant. Terneros'
      end
      item
        DataField = 'CANTNOVILLO'
        Title = 'Cant. Novillos'
      end
      item
        DataField = 'CANTTORO'
      ...
      item
        DataField = 'CANTTERNERA'
        Title = 'Cant. Terneras'
      end
      item
        DataField = 'CANTVAQUILLONA'
        Title = 'Cant. Vaquillonas'
      end
      item
        DataField = 'CANTVACAS'
        Title = 'Cant. Vacas'
      end>
    Title.Text = 'Existencia Rodeo / Potrero'
    Left = 24
    Top = 5
  end
  ...
  object IBQRodeosPotreros: TIBQuery
    Database = FPrincipal.IBDPrincipal
    Transaction = FPrincipal.IBTPrincipal
    AfterOpen = IBQRodeosPotrerosAfterOpen
    BufferChunks = 1000
    CachedUpdates = False
    SQL.Strings = (
      
        'select id_potrero,nombre,hectareas from tab_potreros where (esta' +
        'blecimiento = :esta)')
    Left = 512
    Top = 37
    ParamData = <
  ...
  object DSRodeosPotreros: TDataSource
    DataSet = IBQRodeosPotreros
    Left = 544
    Top = 37
  end
  object IBQExistRodeoPotrero: TIBQuery
    Database = FPrincipal.IBDPrincipal
    Transaction = FPrincipal.IBTPrincipal
    AutoCalcFields = False
    AfterOpen = IBQExistRodeoPotreroAfterOpen
    BufferChunks = 1000
    CachedUpdates = False
    SQL.Strings = (
      'select * from REP_EXISTENCIA_RODEO_POTRERO (:esta,:tipo)')
    Left = 408
    Top = 373
    ParamData = <
      item
  ...
  object DSExistRodeoPotrero: TDataSource
    DataSet = IBQExistRodeoPotrero
    Left = 480
    Top = 373
  end
  object IBQGenIDPotrerosRodeosDisp: TIBQuery
    Database = FPrincipal.IBDPrincipal
    Transaction = FPrincipal.IBTPrincipal
    BufferChunks = 1000
    CachedUpdates = False
  ...
  object IBDSPotrerosRodeos: TIBDataSet
    Database = FPrincipal.IBDPrincipal
    Transaction = FPrincipal.IBTPrincipal
    AfterOpen = IBDSPotrerosRodeosAfterOpen
    BufferChunks = 1000
    CachedUpdates = False
    InsertSQL.Strings = (
    ...
    ModifySQL.Strings = (
      ...
      'WHERE (ID_AUX=:ID_AUX)')
    DataSource = DSRodeosPotreros
    Left = 660
    object IBDSPotrerosRodeosID_AUX: TIntegerField
      FieldName = 'ID_AUX'
      Origin = 'AUX_ANIMALES.ID_AUX'
      Required = True
    end
    object IBDSPotrerosRodeosID_ANIMAL: TIntegerField
      FieldName = 'ID_ANIMAL'
      Origin = 'AUX_ANIMALES.ID_ANIMAL'
      Required = True
    end
    object IBDSPotrerosRodeosNOMBRE: TIBStringField
      FieldName = 'NOMBRE'
      Origin = 'AUX_ANIMALES.NOMBRE'
      Size = 50
    end
    object IBDSPotrerosRodeosRAZA: TIntegerField
      FieldName = 'RAZA'
  ...
  object IBQPasarCategorias: TIBQuery
    Database = FPrincipal.IBDPrincipal
    Transaction = FPrincipal.IBTPrincipal
    BufferChunks = 1000
    CachedUpdates = False
    SQL.Strings = (
      'execute procedure rep_pasar_categ_grupo(:esta, :pot)')
    Left = 600
    Top = 366
    ParamData = <
      item
  ...
  object IBQGrupos: TIBQuery
    ...
    CachedUpdates = False
    SQL.Strings = (
      'select distinct(nombre) from aux_animales')
    Left = 568
    Top = 366
  end
  object IBQCantporGrupo: TIBQuery
    Database = FPrincipal.IBDPrincipal
    Transaction = FPrincipal.IBTPrincipal
    BufferChunks = 1000
    CachedUpdates = False
    SQL.Strings = (
        ...
        'select establecimiento, apodo, nombre from aux_animales where no' +
        'mbre = :n')
    Left = 664
    Top = 366
    ParamData = <
  ...
  object IBQTotalPorRodeo: TIBQuery
    Database = FPrincipal.IBDPrincipal
    Transaction = FPrincipal.IBTPrincipal
    BufferChunks = 1000
    CachedUpdates = False
    SQL.Strings = (
        ...
        'select sum(establecimiento) as suma, nombre from aux_animales gr' +
        'oup by nombre')
    Left = 568
    Top = 334
  end
  object IBQTotalPorCat: TIBQuery
    Database = FPrincipal.IBDPrincipal
    Transaction = FPrincipal.IBTPrincipal
    BufferChunks = 1000
    CachedUpdates = False
    SQL.Strings = (
        ...
        'select sum(establecimiento) as suma, apodo from aux_animales gro' +
        'up by apodo')
    Left = 600
    Top = 334
  end
