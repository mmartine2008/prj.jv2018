inherited FREPExistenciaPorLote: TFREPExistenciaPorLote
  Left = 100
  Top = 124
  BorderIcons = [biSystemMenu, biMinimize]
  BorderStyle = bsSingle
  Caption = 'Existencia por Potrero'
  ClientHeight = 467
  ClientWidth = 860
  OldCreateOrder = True
  OnClose = FormClose
  ...
  object PCDatos: TPageControl [4]
    ...
    object TSSelector: TTabSheet
      Caption = 'Seleccionar Potreros '
      inline FrameSeleccionPotrero: TFrameSeleccion
        Left = 0
        Top = 0
        Width = 852
        Height = 250
        ...
        inherited PSeleccion: TPanel
          ...
          inherited PBotones: TPanel
            ...
            inherited BBAgregarTodos: TJvImage
              ...
              Width = 107
              Height = 60
              OnClick = FrameSeleccionPotreroBBAgregarTodosClick
            end
            inherited BBAgregarUno: TJvImage
              ...
              Width = 109
              Height = 57
              OnClick = FrameSeleccionPotreroBBAgregarUnoClick
            end
            inherited BBEliminarUno: TJvImage
              ...
              Width = 109
              Height = 62
              OnClick = FrameSeleccionPotreroBBEliminarUnoClick
            end
            inherited BBEliminarTodos: TJvImage
              ...
              Width = 109
              Height = 59
              OnClick = FrameSeleccionPotreroBBEliminarTodosClick
            end
        ...
        inherited IBQDisponibles: TIBQuery
          AfterOpen = FrameSeleccionPotreroIBQDisponiblesAfterOpen
          BeforeOpen = FrameSeleccionPotreroIBQDisponiblesBeforeOpen
          SQL.Strings = (
            'SELECT A.ID_ANIMAL AS ID, A.NOMBRE, A.RAZA'
            'FROM AUX_ANIMALES A '
            'WHERE (A.ID_AUX = :IDAUXPE) and A.ID_ANIMAL NOT IN '
            '(SELECT AE.ID_ANIMAL_EXTERNO'
            ' FROM AUX_ANIMALES_EXTERNOS AE '
            ' WHERE (AE.ID_AUX=:IDAUXPE)) ORDER BY A.NOMBRE ASC')
          ParamData = <
            item
              DataType = ftUnknown
              Name = 'IDAUXPE'
        ...
        inherited IBUSQLIntercambiar: TIBUpdateSQL
          RefreshSQL.Strings = (
            'SELECT ID_ANIMAL_EXTERNO, NOMBRE, RAZA '
            'FROM AUX_ANIMALES_EXTERNOS '
            'WHERE (ID_AUX=:ID_AUX)')
          ModifySQL.Strings = (
            'UPDATE AUX_ANIMALES_EXTERNOS'
            'SET ID_AUX=:ID_AUX, ID_ANIMAL_EXTERNO=:ID_ANIMAL_EXTERNO,'
            'NOMBRE=:NOMBRE, RAZA=:RAZA')
          InsertSQL.Strings = (
            'INSERT INTO AUX_ANIMALES_EXTERNOS '
            '(ID_AUX, ID_ANIMAL_EXTERNO, NOMBRE, RAZA) '
            'VALUES (:ID_AUX, :ID_ANIMAL_EXTERNO, :NOMBRE, :RAZA)')
          DeleteSQL.Strings = (
            'delete from AUX_ANIMALES_EXTERNOS'
            'where'
            '  ID_AUX = :OLD_ID_AUX and'
            '  ID_ANIMAL_EXTERNO = :OLD_ID_ANIMAL_EXTERNO and'
            '  NOMBRE = :OLD_NOMBRE and '
            '  RAZA=:RAZA')
          Left = 381
        end
        inherited IBQSeleccionados: TIBQuery
          BeforeOpen = FrameSeleccionPotreroIBQSeleccionadosBeforeOpen
          SQL.Strings = (
            'select ID_AUX, ID_ANIMAL_EXTERNO, NOMBRE, RAZA '
            'FROM AUX_ANIMALES_EXTERNOS '
            'WHERE (ID_AUX=:ID_AUX)')
          Left = 648
          Top = 169
    ...
    object TSDatos: TTabSheet
      Caption = 'Datos de los Potreros Seleccionados'
      ImageIndex = 1
      OnShow = TSDatosShow
      object Label1: TLabel
        ...
        Width = 115
        Height = 14
        Caption = 'Potreros Seleccionados'
      end
      object BDBGPotrerosSeleccionados: TBitDBGrid
        Left = 9
        Top = 51
        Width = 388
        Height = 285
        Cursor = crHandPoint
        DataSource = DSPotrerosSeleccionados
        ...
        TitleFont.Style = []
        OnCellClick = BDBGPotrerosSeleccionadosCellClick
      ...
      object GroupBox1: TGroupBox
        ...
        object Label4: TLabel
          ...
          Width = 128
          Height = 14
          Caption = 'Recurso Forrajero Actual: '
        end
        object Label5: TLabel
          ...
          Width = 127
          Height = 14
          Caption = 'Fecha Recurso Forrajero: '
        end
        object LRecursoForrajero: TLabel
          Left = 153
          Top = 82
          Width = 4
          Height = 14
        ...
        object CabNovHa: TLabel
          Left = 198
          Top = 153
          Width = 84
          Height = 14
          Caption = 'Cab. Novillo / Ha: '
          Enabled = False
        end
        object CabTeraHa: TLabel
          Left = 198
          Top = 181
          Width = 97
          Height = 14
          Caption = 'Cab. Terneras / Ha: '
          Color = clWhite
          Enabled = False
          ParentColor = False
        end
        object CabTeroHa: TLabel
          Left = 198
          Top = 208
          Width = 97
          Height = 14
          Caption = 'Cab. Terneros / Ha: '
          Enabled = False
        end
        object CabToroHa: TLabel
          Left = 198
          Top = 235
          Width = 81
          Height = 14
          Caption = 'Cab. Toros / Ha: '
          Enabled = False
        end
        object CabVacaHa: TLabel
          Left = 198
          Top = 263
          Width = 85
          Height = 14
          Caption = 'Cab. Vacas / Ha: '
          Enabled = False
        end
        object CabVaqHa: TLabel
          Left = 198
          Top = 291
          Width = 109
          Height = 14
          Caption = 'Cab. Vaquillonas / Ha: '
          Enabled = False
        end
        object LCabNovHa: TLabel
          Left = 322
          Top = 153
          Width = 4
          Height = 14
  ...
  object PBotones: TPanel [5]
    ...
    object Label9: TLabel
      ...
      Width = 164
      Height = 14
      Caption = 'Evoluci'#243'n de Recursos Forrajeros'
      Transparent = True
    end
    object ISig: TImage
      Left = 640
    ...
    object RBRecForraje: TRadioButton
      Left = 110
      Top = 70
      Width = 14
      Height = 18
  ...
  inherited DTXLS: TDataToXLS
    DataSet = FrameSeleccionPotrero.IBQSeleccionados
    Left = 0
    Top = 1
  end
  ...
  object IBDSPotreros: TIBDataSet
    Database = FPrincipal.IBDPrincipal
    Transaction = FPrincipal.IBTPrincipal
    AfterOpen = IBDSPotrerosAfterOpen
    BufferChunks = 1000
    CachedUpdates = False
    InsertSQL.Strings = (
      'INSERT INTO AUX_ANIMALES (ID_AUX, ID_ANIMAL, NOMBRE, RAZA) '
      'VALUES (:ID_AUX, :ID_ANIMAL, :NOMBRE, :RAZA)')
    RefreshSQL.Strings = (
      'SELECT ID_AUX, ID_ANIMAL, NOMBRE,RAZA FROM AUX_ANIMALES'
      'WHERE (ID_AUX=:ID_AUX)')
    SelectSQL.Strings = (
      'SELECT ID_AUX, ID_ANIMAL, NOMBRE, RAZA FROM AUX_ANIMALES')
    ModifySQL.Strings = (
      'UPDATE AUX_ANIMALES '
      'SET ID_ANIMAL=:ID_POTRERO, NOMBRE=:NOMBRE, RAZA=:RAZA'
      'WHERE (ID_AUX=:ID_AUX)')
    DataSource = DSPotrero
    Left = 676
    object IBDSPotrerosID_AUX: TIntegerField
      FieldName = 'ID_AUX'
      Origin = 'AUX_ANIMALES.ID_AUX'
      Required = True
    end
    object IBDSPotrerosID_ANIMAL: TIntegerField
      FieldName = 'ID_ANIMAL'
      Origin = 'AUX_ANIMALES.ID_ANIMAL'
      Required = True
    end
    object IBDSPotrerosNOMBRE: TIBStringField
      FieldName = 'NOMBRE'
      Origin = 'AUX_ANIMALES.NOMBRE'
      Size = 50
    end
    object IBDSPotrerosRAZA: TIntegerField
      FieldName = 'RAZA'
  ...
  object IBQPotrero: TIBQuery
    Database = FPrincipal.IBDPrincipal
    Transaction = FPrincipal.IBTPrincipal
    AfterOpen = IBQPotreroAfterOpen
    BufferChunks = 1000
    CachedUpdates = False
    SQL.Strings = (
      'SELECT ID_POTRERO, NOMBRE, HECTAREAS'
      'FROM TAB_POTREROS'
  ...
  object IBQGenIDPotrerosDisp: TIBQuery
    Database = FPrincipal.IBDPrincipal
    Transaction = FPrincipal.IBTPrincipal
    BufferChunks = 1000
    CachedUpdates = False
    SQL.Strings = (
      'SELECT GEN_ID(GEN_ID_AUXGRUPO, 1)  AS IDAUX FROM RDB$DATABASE')
    Left = 168
  end
  object IBQLimpiarAuxExternos: TIBQuery
    Database = FPrincipal.IBDPrincipal
    Transaction = FPrincipal.IBTPrincipal
    BufferChunks = 1000
    CachedUpdates = False
  ...
  object IBQPotrerosSeleccionados: TIBQuery
    Database = FPrincipal.IBDPrincipal
    Transaction = FPrincipal.IBTPrincipal
    BufferChunks = 1000
    CachedUpdates = False
    SQL.Strings = (
      'SELECT ID_ANIMAL_EXTERNO AS ID, NOMBRE '
      'FROM AUX_ANIMALES_EXTERNOS')
    Left = 500
  end
  object DSPotrerosSeleccionados: TDataSource
    DataSet = IBQPotrerosSeleccionados
    Left = 536
  end
  object IBSPCantidades: TIBStoredProc
    Database = FPrincipal.IBDPrincipal
    Transaction = FPrincipal.IBTPrincipal
    StoredProcName = 'REP_CATEGORIAS_POTRERO'
    Left = 352
    Top = 403
    ParamData = <
      item
      ...
      item
        DataType = ftUnknown
        Name = 'RECURSO_FORRAJERO'
        ParamType = ptUnknown
        Size = 50
      end>
    object IBSPCantidadesCANT_TOROS: TIntegerField
      FieldName = 'CANT_TOROS'
      Origin = 'REP_CATEGORIAS_POTRERO.CANT_TOROS'
    end
    object IBSPCantidadesCANT_VACAS: TIntegerField
      FieldName = 'CANT_VACAS'
      Origin = 'REP_CATEGORIAS_POTRERO.CANT_VACAS'
    end
    object IBSPCantidadesCANT_TERNEROS: TIntegerField
      FieldName = 'CANT_TERNEROS'
      Origin = 'REP_CATEGORIAS_POTRERO.CANT_TERNEROS'
    end
    object IBSPCantidadesCANT_NOVILLOS: TIntegerField
      FieldName = 'CANT_NOVILLOS'
      Origin = 'REP_CATEGORIAS_POTRERO.CANT_NOVILLOS'
    end
    object IBSPCantidadesCANT_TERNERAS: TIntegerField
      FieldName = 'CANT_TERNERAS'
      Origin = 'REP_CATEGORIAS_POTRERO.CANT_TERNERAS'
    end
    object IBSPCantidadesCANT_VAQUILLONAS: TIntegerField
      FieldName = 'CANT_VAQUILLONAS'
      Origin = 'REP_CATEGORIAS_POTRERO.CANT_VAQUILLONAS'
    end
    object IBSPCantidadesRECURSO_FORRAJERO: TIBStringField
      DisplayWidth = 50
      FieldName = 'RECURSO_FORRAJERO'
      Origin = 'REP_CATEGORIAS_POTRERO.RECURSO_FORRAJERO'
    end
    object IBSPCantidadesFECHA_RECURSO: TDateField
      FieldName = 'FECHA_RECURSO'
      Origin = 'REP_CATEGORIAS_POTRERO.FECHA_RECURSO'
    end
    object IBSPCantidadesTOTAL: TIntegerField
      FieldName = 'TOTAL'
      Origin = 'REP_CATEGORIAS_POTRERO.TOTAL'
    end
  end
end
