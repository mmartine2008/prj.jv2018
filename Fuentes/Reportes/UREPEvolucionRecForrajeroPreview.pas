unit UREPEvolucionRecForrajeroPreview;
...
type
  TFREPEvolucionRecForrajeroPreview = class(TFUniversal)
    QREvolucionRecForrajeros: TQuickRep;
    QRBand1: TQRBand;
    QRImage2: TQRImage;
    QRLabel4: TQRLabel;
    QRBand5: TQRBand;
    ...
    procedure QREvolucionRecForrajerosBeforePrint(Sender: TCustomQuickRep;
...
var
  FREPEvolucionRecForrajeroPreview: TFREPEvolucionRecForrajeroPreview;
...
procedure TFREPEvolucionRecForrajeroPreview.QREvolucionRecForrajerosBeforePrint(
...
begin
  ...
  IBQForrajes.Active := false;
  IBQForrajes.ParamByName('esta').AsInteger := FPrincipal.EstablecimientoActual;
  IBQForrajes.Active := true;

  cargarDatosPropietario();
end;

procedure TFREPEvolucionRecForrajeroPreview.FormShow(Sender: TObject);
var
  H : HWND;
begin
  inherited;
  QREvolucionRecForrajeros.Preview;
...
procedure TFREPEvolucionRecForrajeroPreview.cargarDatosPropietario;
var
