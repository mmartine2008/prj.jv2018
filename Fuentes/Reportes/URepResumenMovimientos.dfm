inherited FResumenMovimientos: TFResumenMovimientos
  Left = 159
  Top = 33
  ...
  object PFiltros: TPanel [4]
    ...
    object GBFiltros: TGroupBox
      ...
      object Label3: TLabel
        ...
        Width = 368
        Height = 16
        Caption = 'Buscar por: RP / HBA / ABA / SENASA / NOMBRE / APODO '
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clWindowText
        Font.Height = -13
        Font.Name = 'Arial'
      ...
      object DTPHasta: TDateTimePickerAuto
        Left = 67
        Top = 56
        Width = 94
        Height = 23
        Date = 40816.418249050920000000
        Time = 40816.418249050920000000
        Color = clWhite
        Enabled = False
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clWindowText
      ...
      object DTPDesde: TDateTimePickerAuto
        Left = 67
        Top = 24
        Width = 94
        Height = 23
        Date = 40816.418222291670000000
        Time = 40816.418222291670000000
        Color = clWhite
        Enabled = False
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clWindowText
  ...
  object PGrillaDatos: TPanel [5]
    ...
    object GBGrilla: TGroupBox
      ...
      ParentFont = False
      TabOrder = 0
      object BDBGDatosAnimales: TBitDBGrid
        Left = 2
        Top = 18
        Width = 1005
        Height = 327
        Align = alClient
        DataSource = DSDatosAnimales
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clWindowText
        Font.Height = -13
        Font.Name = 'Arial'
        ...
        OnDblClick = BDBGDatosAnimalesDblClick
  ...
  object IBQDestino: TIBQuery
    ...
    CachedUpdates = False
    SQL.Strings = (
      'select id_dest_cabania, sinonimo from cod_dest_cabania')
    Left = 937
    Top = 114
  end
  object IBQDatosAnimales: TIBQuery
    Database = FPrincipal.IBDPrincipal
    Transaction = FPrincipal.IBTPrincipal
    BufferChunks = 1000
    CachedUpdates = False
    SQL.Strings = (
      'select *'
        ...
        'from sp_resumen_mov(:estable, :fecha_desde, :fecha_hasta,  :cate' +
        'goria, :destino, :origen, :potrero, :raza, :rodeo, :tiporegistro' +
        ', :tipobaja, :estado)'
      'order by id_rp')
    Left = 17
    Top = 363
  ...
  object DSDatosAnimales: TDataSource
    DataSet = IBQDatosAnimales
    Left = 17
    Top = 331
  end
  object IBQDatosMov: TIBQuery
    Database = FPrincipal.IBDPrincipal
    Transaction = FPrincipal.IBTPrincipal
    BufferChunks = 1000
    CachedUpdates = False
