inherited FREPDGDistribucionPrenezCACUCOPreview: TFREPDGDistribucionPrenezCACUCOPreview
  Left = 127
  Top = 162
  Caption = 'FREPDGDistribucionPrenezCACUCOPreview'
  ClientHeight = 458
  ClientWidth = 951
  OldCreateOrder = True
  Scaled = False
  ...
  object QRContenido: TQuickRep [4]
    ...
    DataSet = FREPDGDistribucionPrenezCACUCO.IBQAnimales
    ...
    object QRBEncabezadoPlanilla: TQRBand
      ...
      object QRLTituloPlanilla: TQRLabel
        ...
        AutoSize = True
        AutoStretch = False
        Caption = 'Reporte de distribuci'#243'n'
        Color = clWhite
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clWindowText
        Font.Height = -19
