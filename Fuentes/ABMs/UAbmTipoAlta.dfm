inherited FABMTipoAlta: TFABMTipoAlta
  Left = 270
  Top = 181
  Caption = 'Huella - Tipo de Alta.'
  PixelsPerInch = 96
  TextHeight = 14
  ...
  inherited PTitulo: TPanel
    Caption = 'Tipos de Alta'
  end
  inherited IBQAbmSimple: TIBQuery
    SQL.Strings = (
      'select id_tipo_alta, codigo, nombre, sinonimo'
      'from cod_tipos_alta tp')
    GeneratorField.Field = 'ID_TIPO_ALTA'
    GeneratorField.Generator = 'GEN_ID_CODTIPOSALTA'
  end
  inherited IBUSQLAbmSimple: TIBUpdateSQL
    RefreshSQL.Strings = (
      ...
      'from cod_tipos_alta '
      'where'
      '  ID_TIPO_ALTA = :ID_TIPO_ALTA')
    ModifySQL.Strings = (
      'update cod_tipos_alta'
      'set'
      '  ID_TIPO_ALTA = :ID_TIPO_ALTA,'
      '  CODIGO = :CODIGO,'
      '  NOMBRE = :NOMBRE,'
      '  SINONIMO = :SINONIMO'
      'where'
      '  ID_TIPO_ALTA = :OLD_ID_TIPO_ALTA')
    InsertSQL.Strings = (
      'insert into cod_tipos_alta'
      '  (ID_TIPO_ALTA, CODIGO, NOMBRE, SINONIMO)'
      'values'
      '  (:ID_TIPO_ALTA, :CODIGO, :NOMBRE, :SINONIMO)')
    DeleteSQL.Strings = (
      'delete from cod_tipos_alta'
      'where'
      '  ID_TIPO_ALTA = :OLD_ID_TIPO_ALTA')
  end
end
