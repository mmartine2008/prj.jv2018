inherited FABMTipoTratamiento: TFABMTipoTratamiento
  Left = 267
  Top = 165
  Caption = 'Huella - Tipo de Tratamiento.'
  PixelsPerInch = 96
  TextHeight = 14
  ...
  inherited PTitulo: TPanel
    Caption = 'Tipos de Tratamiento'
  end
  inherited IBQAbmSimple: TIBQuery
    SQL.Strings = (
      'select id_tipo_tratamiento, codigo, nombre, sinonimo'
      'from cod_tipos_tratamiento tp')
    GeneratorField.Field = 'ID_TIPO_TRATAMIENTO'
    GeneratorField.Generator = 'GEN_ID_CODTIPOSTRATAMIENTO'
  end
  inherited IBUSQLAbmSimple: TIBUpdateSQL
    ...
    ModifySQL.Strings = (
      ...
      '  SINONIMO = :SINONIMO'
      'where'
      '  ID_TIPO_TRATAMIENTO = :OLD_ID_TIPO_TRATAMIENTO')
    InsertSQL.Strings = (
      'insert into cod_tipos_tratamiento'
      '  (ID_TIPO_TRATAMIENTO, CODIGO, NOMBRE, SINONIMO)'
      'values'
      '  (:ID_TIPO_TRATAMIENTO, :CODIGO, :NOMBRE, :SINONIMO)')
    DeleteSQL.Strings = (
      'delete from cod_tipos_tratamiento'
      'where'
      '  ID_TIPO_TRATAMIENTO = :OLD_ID_TIPO_TRATAMIENTO')
  end
end
