inherited FABMGdr: TFABMGdr
  ...
  inherited PTitulo: TPanel
    Caption = 'Grados de Desarrollo Reproductivo'
  end
  ...
  inherited IBQAbmSimple: TIBQuery
    SQL.Strings = (
      'select id_gdr, codigo, nombre, sinonimo'
      'from cod_gdr tp')
    GeneratorField.Field = 'ID_GDR'
    GeneratorField.Generator = 'GEN_ID_CODGDR'
  end
