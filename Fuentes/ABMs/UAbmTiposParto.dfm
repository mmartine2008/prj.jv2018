inherited FABMTiposParto: TFABMTiposParto
  Left = 291
  Top = 204
  Caption = 'Huella - Tipo de Parto.'
  PixelsPerInch = 96
  TextHeight = 14
  ...
  inherited PTitulo: TPanel
    Caption = 'Tipos de Parto'
  end
  inherited IBQAbmSimple: TIBQuery
    SQL.Strings = (
      'select id_tipo_parto, codigo, nombre, sinonimo'
      'from cod_tipos_parto tp')
    GeneratorField.Field = 'ID_TIPO_PARTO'
    GeneratorField.Generator = 'GEN_ID_CODTIPOSPARTO'
  end
  inherited IBUSQLAbmSimple: TIBUpdateSQL
    RefreshSQL.Strings = (
      ...
      'where'
      '  ID_TIPO_PARTO = :ID_TIPO_PARTO')
    ModifySQL.Strings = (
      'update cod_tipos_parto'
      'set'
      '  ID_TIPO_PARTO = :ID_TIPO_PARTO,'
      '  CODIGO = :CODIGO,'
      '  NOMBRE = :NOMBRE,'
      '  SINONIMO = :SINONIMO'
      'where'
      '  ID_TIPO_PARTO = :OLD_ID_TIPO_PARTO')
    InsertSQL.Strings = (
      'insert into cod_tipos_parto'
      '  (ID_TIPO_PARTO, CODIGO, NOMBRE, SINONIMO)'
      'values'
      '  (:ID_TIPO_PARTO, :CODIGO, :NOMBRE, :SINONIMO)')
    DeleteSQL.Strings = (
      'delete from cod_tipos_parto'
      'where'
      '  ID_TIPO_PARTO = :OLD_ID_TIPO_PARTO')
  end
end
