inherited FListadoEmbriones: TFListadoEmbriones
  Left = 349
  Top = 17
  Caption = 'FListadoEmbriones'
  ClientHeight = 690
  ClientWidth = 813
  OldCreateOrder = True
  PixelsPerInch = 96
  ...
  object PEmbriones: TPanel [4]
    ...
    object GBEmbriones: TGroupBox
      ...
      object BDBGEmbriones: TBitDBGrid
        ...
        TitleFont.Style = []
        OnDblClick = BDBGEmbrionesDblClick
  ...
  object GBFiltros: TGroupBox [5]
    ...
    Caption = 'Filtros'
    TabOrder = 3
    object GBTiposFiltros: TGroupBox
      Left = 122
      Top = 16
      Width = 689
      Height = 123
      ...
      object CBDestino: TCheckBox
        ...
        Enabled = False
        TabOrder = 0
        OnClick = CBDestinoClick
      end
      object CBDonante: TCheckBox
        Left = 421
        Top = 57
        Width = 80
        Height = 18
      ...
      object DBLCBAToro: TDBLookupComboBoxAuto
        Left = 494
        Top = 88
        Width = 180
        Height = 22
      ...
      object CBEnvase: TCheckBox
        ...
        Width = 106
        Height = 18
        Caption = 'Nro. de Envase:'
        Enabled = False
        TabOrder = 7
        OnClick = CBEnvaseClick
      end
      object CBEstadio: TCheckBox
        Left = 33
        Top = 92
        Width = 63
        Height = 18
        ...
        Enabled = False
        TabOrder = 8
        OnClick = CBEstadioClick
      end
      object EAMSerie: TEditAutoMinuscula
        Left = 143
        Top = 19
        Width = 202
        Height = 22
        ...
        Enabled = False
        TabOrder = 9
        OnChange = EAMSerieChange
        EsClave = False
        EsRequerido = False
        ISParam = False
      end
      object EAMEnvase: TEditAutoMinuscula
        Left = 143
        Top = 55
        Width = 202
        Height = 22
      ...
      object DBLCBAEstadio: TDBLookupComboBoxAuto
        ...
        TabOrder = 11
        OnCloseUp = DBLCBAEstadioCloseUp
        EsClave = False
        EsRequerido = False
        ISParam = False
      end
      object DBLCBACalidad: TDBLookupComboBoxAuto
        ...
        TabOrder = 12
        OnCloseUp = DBLCBACalidadCloseUp
        EsClave = False
        EsRequerido = False
        ISParam = False
      end
      object CBCalidad: TCheckBox
        Left = 197
        Top = 92
        Width = 66
        Height = 18
  ...
  object POpciones: TPanel [6]
    ...
    object GBGrupos: TGroupBox
      ...
      object DBLCBAGrupos: TDBLookupComboBoxAuto
        Left = 69
        Top = 44
        Width = 294
        Height = 22
  ...
  inherited DTXLS: TDataToXLS
    ...
    Columns = <
      ...
      item
        DataField = 'VAL_ESTADIO'
        Title = 'Estadio'
      end
      item
        DataField = 'VAL_CALIDAD'
        Title = 'Calidad'
      end
      item
        DataField = 'NOM_DEST'
      ...
      item
        ...
        Title = 'Dias desde Celo'
      end
      item
        DataField = 'ESTADO'
        Title = 'Estado'
      end>
    Title.Text = 'Listado de Embriones'
    Left = 152
    Top = 1
  end
  ...
  object IBQEmbriones: TIBQuery
    ...
    OnCalcFields = IBQEmbrionesCalcFields
    BufferChunks = 1000
    CachedUpdates = False
    SQL.Strings = (
      'select * from tab_embriones where establecimiento = :esta')
    Left = 640
    Top = 416
    ParamData = <
      item
    ...
    object IBQEmbrionesVAL_CALIDAD: TIntegerField
      FieldKind = fkLookup
      FieldName = 'VAL_CALIDAD'
    ...
    object IBQEmbrionesVAL_ESTADIO: TIntegerField
      FieldKind = fkLookup
      FieldName = 'VAL_ESTADIO'
    ...
    object IBQEmbrionesNOM_DEST: TStringField
      FieldKind = fkLookup
      FieldName = 'NOM_DEST'
    ...
    object IBQEmbrionesNOM_DESC: TStringField
      FieldKind = fkLookup
      FieldName = 'NOM_DESC'
      LookupDataSet = IBQDescripcion
      LookupKeyFields = 'ID_DESCRIPCION'
      LookupResultField = 'NOMBRE'
      KeyFields = 'DESCRIPCION'
      Size = 100
      Lookup = True
    end
    object IBQEmbrionesESTADO: TStringField
  ...
  object IBQDestinos: TIBQuery
    ...
    CachedUpdates = False
    SQL.Strings = (
      'select id_destino_embrion, nombre from cod_destino_embrion')
    Left = 529
    Top = 450
  end
  ...
  object IBQPadres: TIBQuery
    Database = FPrincipal.IBDPrincipal
    Transaction = FPrincipal.IBTPrincipal
    OnCalcFields = IBQPadresCalcFields
    BufferChunks = 1000
    CachedUpdates = False
    SQL.Strings = (
      
        'SELECT ID_ANIMAL AS ID, ID_RP,NOMBRE,ID_HBA, '#39'N'#39' AS EXTERNO FROM' +
        ' TAB_ANIMALES WHERE ESTABLECIMIENTO = :ESTABLECIMIENTO AND SEXO ' +
        '= 1'
      'UNION'
      
        'SELECT ID_ANIMAL_EXTERNO AS ID, ID_RP,NOMBRE,ID_HBA, '#39'S'#39' AS EXTE' +
        'RNO FROM TAB_ANIMALES_EXTERNOS WHERE ESTABLECIMIENTO = :ESTABLEC' +
        'IMIENTO AND SEXO = 1')
    Left = 529
    Top = 418
    ParamData = <
    ...
    object IBQPadresID: TIntegerField
      FieldName = 'ID'
      Required = True
    end
    ...
    object IBQPadresEXTERNO: TIBStringField
      FieldName = 'EXTERNO'
      Required = True
      FixedChar = True
      Size = 1
    end
    object IBQPadresNOM: TStringField
      FieldKind = fkCalculated
      FieldName = 'NOM'
      Calculated = True
    end
  ...
  object IBQMadres: TIBQuery
    Database = FPrincipal.IBDPrincipal
    Transaction = FPrincipal.IBTPrincipal
    OnCalcFields = IBQMadresCalcFields
    BufferChunks = 1000
    CachedUpdates = False
    SQL.Strings = (
      
        'SELECT ID_ANIMAL AS ID, ID_RP,NOMBRE,ID_HBA, '#39'S'#39' AS INTERNA FROM' +
        ' TAB_ANIMALES WHERE ESTABLECIMIENTO = :ESTABLECIMIENTO AND SEXO ' +
        '= 2'
      'UNION'
      
        'SELECT ID_ANIMAL_EXTERNO AS ID,ID_RP,NOMBRE,ID_HBA, '#39'N'#39' AS INTER' +
        'NA FROM TAB_ANIMALES_EXTERNOS WHERE ESTABLECIMIENTO = :ESTABLECI' +
        'MIENTO AND SEXO = 2')
    Left = 529
    Top = 386
    ParamData = <
    ...
    object IBQMadresID: TIntegerField
      FieldName = 'ID'
      Required = True
    end
    object IBQMadresID_RP: TIBStringField
      FieldName = 'ID_RP'
      Required = True
      Size = 10
    end
    object IBQMadresNOMBRE: TIBStringField
      FieldName = 'NOMBRE'
      Size = 50
    end
    object IBQMadresID_HBA: TIBStringField
      FieldName = 'ID_HBA'
      Size = 10
    end
    object IBQMadresINTERNA: TIBStringField
      FieldName = 'INTERNA'
      Required = True
      FixedChar = True
      Size = 1
    end
    object IBQMadresNOM: TStringField
      FieldKind = fkCalculated
      FieldName = 'NOM'
      Calculated = True
    end
  ...
  object IBQGrupos: TIBQuery
    ...
    SQL.Strings = (
        ...
        'select id_grupo, nombre from tab_grupos where establecimiento = ' +
        ':esta and '
      
        '((tipo = '#39'S'#39' and (tipo_evento = 47 or tipo_evento = 48 or tipo_e' +
        'vento = 26 or tipo_evento = 27 or tipo_evento = 28 or tipo_event' +
        'o = 11)) or tipo = '#39'U'#39') and visible = 1')
    Left = 584
    Top = 137
    ParamData = <
      item
    ...
    object IBQGruposID_GRUPO: TIntegerField
      FieldName = 'ID_GRUPO'
      Origin = 'TAB_GRUPOS.ID_GRUPO'
      Required = True
    end
    object IBQGruposNOMBRE: TIBStringField
      FieldName = 'NOMBRE'
      Origin = 'TAB_GRUPOS.NOMBRE'
      Required = True
      Size = 50
    end
  end
  ...
  object IBQAgregarEmbrionAux: TIBQuery
    Database = FPrincipal.IBDPrincipal
    Transaction = FPrincipal.IBTPrincipal
    BufferChunks = 1000
    CachedUpdates = False
    SQL.Strings = (
        ...
        'insert into aux_embriones values (:id,:esta,:fecha,:dest,null,:d' +
        'esc,null,:serie,:envase,:estadio,null,:calidad,null,:resp,null,:' +
        'observacion,:madre,:padre1,:padre2,:ext1,:ext2,:mint,:usado,:lav' +
        'ajes,:precio,:centro,:dias,:orden)')
    Left = 321
    Top = 466
    ParamData = <
      item
  ...
  object IBQModificarEmbriones: TIBQuery
    Database = FPrincipal.IBDPrincipal
    Transaction = FPrincipal.IBTPrincipal
    BufferChunks = 1000
    CachedUpdates = False
    SQL.Strings = (
        ...
        'update tab_embriones set serie = :serie, nro_orden = :orden, nro' +
        '_envase = :envase, cant_lavajes = :lavajes, estadio = :estadio, ' +
        'calidad = :calidad, destino = :destino, descripcion = :descripci' +
        'on where id_embrion = :id')
    Left = 353
    Top = 466
    ParamData = <
      item
  ...
  object IBQEmbrionAux: TIBQuery
    Database = FPrincipal.IBDPrincipal
    Transaction = FPrincipal.IBTPrincipal
    BufferChunks = 1000
    CachedUpdates = False
    SQL.Strings = (
      'select * from aux_embriones where id_embrion = :id')
    Left = 353
    Top = 498
    ParamData = <
      item
  ...
  object IBQDescripcion: TIBQuery
    Database = FPrincipal.IBDPrincipal
    Transaction = FPrincipal.IBTPrincipal
    BufferChunks = 1000
    CachedUpdates = False
