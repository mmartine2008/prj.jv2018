...
type
  TFAyudaInicialdos = class(TFUniversal)
...
var
  FAyudaInicialdos: TFAyudaInicialdos;
...
procedure TFAyudaInicialdos.Image11Click(Sender: TObject);
var F : TFMapa;
...
procedure TFAyudaInicialdos.Image12Click(Sender: TObject);
...
procedure TFAyudaInicialdos.Image17Click(Sender: TObject);
var p : String;
begin
  inherited;
